package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      protected var var_161:Boolean = false;
      
      protected var var_86:Map;
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = var_86.getKeys();
         var _loc3_:Boolean = false;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            _loc5_ = _loc2_[_loc4_];
            _loc6_ = var_86[_loc5_];
            _loc7_ = false;
      ...
      {
         var _loc4_:CategoryData = var_86[param1];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:CategoryData = var_86[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         if(!var_86 || !var_47 || true)
         {
            return;
         }
         var _loc2_:CategoryData = var_86[param1];
         if(_loc2_ == null)
         {
            return;
         }
