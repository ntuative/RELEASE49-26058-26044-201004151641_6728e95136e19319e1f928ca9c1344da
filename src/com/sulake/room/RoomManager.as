package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_521:IRoomObjectFactory = null;
      
      private var var_1491:int;
      
      private var var_2391:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_519 = [];
         var_520 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_338,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_440,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_593,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_32 == const_1222)
         {
            if(var_873 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_428.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_428.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_521.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_521 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_520.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
         var_520.splice(_loc2_,1);
         var _loc3_:int = -1;
         while(_loc3_ >= 0)
         {
            _loc4_ = var_100.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_100 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_100.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc2_:IRoomInstance = var_100.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_521 != null)
         {
            return var_521.createRoomObjectManager();
         }
         return null;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_100.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         return var_100.getValue(param1) as IRoomInstance;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_42.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_519.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_519.splice(_loc2_,1);
            }
            if(false)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = var_100.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = var_100.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_428.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_428.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_521.createRoomObjectLogic(_loc18_);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         if(var_100.getValue(param1) != null)
         {
            return null;
         }
         var _loc3_:RoomInstance = new RoomInstance(param1,this);
         var_100.add(String(param1),_loc3_);
         var _loc4_:int = -1;
         while(_loc4_ >= 0)
         {
            _loc5_ = 0;
