package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1224:Boolean = true;
      
      private var var_837:RoomLayout;
      ...
      private var var_1010:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_499 = new Timer(100);
         var_499.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_38 = new Array();
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,104,"a"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,94,"b"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,36,"c"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,84,"d"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"e"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"f"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,416,"i"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,320,"j"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,448,"k"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,352,"l"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,384,"m"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_52,372,"n"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,80,"g"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,74,"h"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,416,"o"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,352,"p"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,304,"q"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,336,"r"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,748,"u"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,438,"v"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,540,"t"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,512,"w"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,396,"x"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,440,"y"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,456,"z"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1010 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_499)
         {
            var_499.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_499.reset();
            var_499 = null;
         }
      }
      ...
      {
         var_1010.goBackToInitialState();
         var_1010.input.textBackgroundColor = 4294967295;
         var_837 = var_38[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_41,HabboWindowParam.const_73,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1010.getText();
      ...
      {
         var _loc1_:Boolean = var_1010.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      private function refreshSelection() : void
      {
         ...
         var _loc2_:* = false;
         var _loc3_:* = null;
         for each(_loc1_ in var_38)
         {
            if(_loc1_.view != null)
            {
               _loc2_ = _loc1_ == var_837;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_837.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1224 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1224 = true;
            _loc3_.y = 1;
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(false)
         {
            _loc6_ = var_48.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in var_38)
         {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_38.length)
         {
            _loc7_ = var_38[_loc4_];
            if(isAllowed(_loc7_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_38[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
