package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_777:MeMenuSettingsView;
      ...
      {
         if(param1.type != WindowEvent.const_456)
         {
            return;
         }
         var_777.saveVolume(getValue(param2.x),false);
      }
      ...
      {
         return param1 / var_1405 * (var_960 - var_649) + var_649;
      }
   }
}
