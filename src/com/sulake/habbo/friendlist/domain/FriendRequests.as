package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_447:IFriendRequestsDeps;
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_803;
         var_447.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_447.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      {
         var_240.push(param1);
         var_447.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            Util.remove(var_240,_loc4_);
            if(false)
            {
               var_447.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
