package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_756:uint = 1;
      
      private static const const_755:uint = 2;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_467:
            ...
            case WindowRedrawFlag.const_1006:
               var_671 = var_672.getTheActualState(param1.type,param1.style,param1.state);
               if(var_671 != var_983)
               {
                  var_216 = true;
                  _loc4_ = true;
      ...
      {
         return var_672.getTheActualState(param1.type,param1.style,param1.state) != var_983;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_755) : uint(const_488);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_671))
            {
               _loc5_ = const_756;
            }
         }
         ...
         if(_loc5_ != const_488)
         {
            if(var_90 == null)
            {
               var_90 = _drawBufferAllocator.allocate(_loc8_,_loc9_,true,param1.color);
               var_216 = true;
            }
            else if(var_90.width != _loc8_ || var_90.height != _loc9_)
            {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_756)
               {
                  ...
                  if(var_216)
                  {
                     ...
                     _loc7_.draw(param1,var_90,var_90.rect,var_671,false);
                     if(!param1.background)
                     {
                        _loc11_ = uint(param1.color);
                        if((_loc11_ & 16777215) < 16777215)
                        {
                           var_90.colorTransform(_loc4_.rect,new ColorTransform(((_loc11_ & 16711680) >> 16) / 255,((_loc11_ & 65280) >> 8) / 255,(_loc11_ & 255) / 255));
                        }
                     }
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_34))
                  {
                     ...
                     _loc4_.draw(var_90,var_945,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_672.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_918)
            {
               _loc2_ = var_672.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_918);
            }
         }
         return _loc2_;
      }
