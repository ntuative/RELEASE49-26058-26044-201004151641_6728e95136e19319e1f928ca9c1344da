package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1643:uint = 6710886;
      ...
      private const const_1645:String = "energy";
      ...
      private var var_214:IBorderWindow;
      
      private const const_1642:int = 158;
      
      private const const_1641:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_165:PetCommandTool;
      
      private const const_1640:uint = 11184810;
      
      private const const_1637:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_214 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_214 != null)
         {
            var_96 = var_214.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_214.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_214.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_96 == null || var_214 == null || var_60 == null)
         {
            return;
         }
         ...
         var_214.height = NaN;
         _window.width = Math.max(var_214.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_165 == null)
         {
            var_165 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1190.getValue(var_569) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_165.showWindow(true);
            var_165.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1637,param1.experience,param1.experienceMax);
         updateStateElement(const_1645,param1.energy,param1.energyMax);
         ...
         if(var_165 && var_165.isVisible() && param1.isOwnPet)
         {
            var_165.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_165.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_165 && var_165.getPetId() == var_569)
               {
                  var_165.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_468,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1642,const_1641,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1640);
         ...
         _loc5_.fillRect(_loc7_,const_1643);
         return _loc5_;
      }
