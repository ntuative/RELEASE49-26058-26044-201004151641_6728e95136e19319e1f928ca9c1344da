package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1127:String = "badges";
      
      private static const const_1124:String = "pet_inventory";
      
      private static const const_1123:String = "pixelbalance";
      
      private static const const_1128:String = "credits";
      
      private static const const_1122:String = "inventory";
      
      private static const const_1121:String = "friendlist";
      
      private static const const_1125:String = "selectfurni";
      
      private static const const_1126:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_623:ParkBusDialogManager;
      
      private var var_622:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_444:HabboNotificationViewManager;
      
      private var var_747:ClubEndingNotification;
      
      private var var_605:IAvatarRenderManager;
      ...
      private var var_202:HabboAlertDialogManager;
      
      private var var_748:ClubGiftNotification;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1290);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_748 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_202 == null)
         {
            return;
         }
         var_202.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1007)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1246);
         }
      ...
      {
         var_360 = param2 as ISessionDataManager;
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_202.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_202.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_605)
         {
            var_605.release(new IIDAvatarRenderManager());
            var_605 = null;
         }
         if(_catalog)
         {
         ...
         if(var_360)
         {
            var_360.release(new IIDSessionDataManager());
            var_360 = null;
         }
         if(var_622)
         {
            var_622.release(new IIDHabboToolbar());
            var_622 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_80:
               ...
               break;
            case CatalogPageMessageProductData.const_210:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1276);
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1124:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_148);
               }
               break;
            case const_1125:
               break;
      ...
      {
         if(param1 != null && this.var_444 != null)
         {
            var_444.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_854,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_605.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1013,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_179 || param2.type == WindowEvent.const_642)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_444.isSpaceAvailable() && false)
         {
            var_444.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_623 == null)
         {
            var_623 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_623 != null)
         {
            var_623.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1086.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_605.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_360);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_360.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc9_ = var_360.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_360.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1336,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_605.createAvatarImage(param2,AvatarScaleType.const_55);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1086.push(_loc8_);
         return var_1086.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1190)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_747 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_202 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_622 = IHabboToolbar(param2);
         var_622.events.addEventListener(HabboToolbarEvent.const_86,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_202.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_360.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_1022);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_1022);
            }
         }
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_605 = param2 as IAvatarRenderManager;
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_202.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_318;
            }
            if(param2 == 4057)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_86)
         {
            ...
            var_444 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_910["styles"],var_910["view"],var_622);
            ...
            registerUpdateReceiver(var_444,1);
            registerUpdateReceiver(this,2);
            var_360.events.addEventListener(BadgeImageReadyEvent.const_128,onBadgeImage);
            var_622.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
