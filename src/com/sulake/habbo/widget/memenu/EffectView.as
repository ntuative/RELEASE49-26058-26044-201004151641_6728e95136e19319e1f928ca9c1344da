package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_897:IWindow;
      
      private var var_896:IWindow;
      ...
      {
         super();
         var_162 = new Timer(1000);
         var_162.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               _window.addEventListener(WindowMouseEvent.const_32,onMouseEvent);
            }
            if(false)
            {
            ...
            var_896 = _window.findChildByName("effect_hilite");
            var_896.visible = false;
         }
         var_895 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_897 = _window.findChildByName("loader_bar");
         if(var_897 != null)
         {
            var_390 = var_897.width;
            var_162.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_162.stop();
            var_162.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_162 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_895 != null)
         {
            var_895.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_895.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
