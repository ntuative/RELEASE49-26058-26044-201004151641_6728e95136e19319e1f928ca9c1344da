package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1592:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1382 == null)
         {
            ...
            var_1382 = var_47.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1609 == null)
         {
            _loc5_ = var_47.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1609 = var_47.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
      ...
      private function createWindow() : void
      {
         ...
         var_1592 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1593 == AvatarEditorSideCategory.WARDROBE || var_2242))
         {
            _loc4_ = "null";
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_705:
               break;
            case AvatarEditorSideCategory.const_370:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_370);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_252 = param1;
         var_1592.setSelected(var_1592.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1593 == AvatarEditorSideCategory.WARDROBE)
         {
            var_2242 = false;
            setSideContent(AvatarEditorSideCategory.const_705);
         }
         else
         {
