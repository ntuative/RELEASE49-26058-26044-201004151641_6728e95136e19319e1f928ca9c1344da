package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1910 = new RoomThumbnailRenderer(param1);
         var_815 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_173,var_114.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_815.refreshTags(_loc1_,var_114.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1910.refreshThumbnail(_loc1_,var_114.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_173,var_114);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_173,!true ? getEventCtg(var_114.categoryId) : getRoomCtg(var_114.categoryId));
         refreshRoomDesc(var_173,var_114);
         refreshExtraCont();
         refreshInfo(var_173,"trading_allowed",var_114.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_219,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
