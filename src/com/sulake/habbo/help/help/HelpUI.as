package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1787:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26058-26044-201004151547");
         var_187 = param5;
         var_97 = new Map();
         var_97.add(HabboHelpViewEnum.const_1279,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_141,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_481,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_265,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_200,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_629,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_322,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_526,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_204,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_97.add(HabboHelpViewEnum.const_991,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_583,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_141 || false)
         {
            return;
         }
         if(var_403 == null)
         {
            ...
            var_403 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_403 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_403 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_403 as IWindow);
      ...
      {
         return var_97.getValue(var_252);
      }
      ...
      {
         var_1789 = param1;
         var _loc2_:IHelpViewController = var_97.getValue(HabboHelpViewEnum.const_141) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_204:
               ...
               break;
            case CallForHelpResultEnum.const_952:
      ...
      {
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_141)
         {
            return;
         }
         if(true)
         {
            ...
            var_568.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_568.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_403.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_568[1],var_568[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_568[0],var_568[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1451;
         _window.width = _loc1_.width + var_1450;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_252);
            return;
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_357));
      }
