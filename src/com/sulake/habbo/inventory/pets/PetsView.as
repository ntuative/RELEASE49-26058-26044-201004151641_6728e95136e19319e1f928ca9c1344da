package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_297:PetsGridItem;
      ...
      private var var_463:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_463 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_584 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_584.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_297 != null)
         {
            var_297.setSelected(false);
         }
         var_297 = param1;
         if(var_297 != null)
         {
            var_297.setSelected(true);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_61)
         {
            ...
            {
               case "tab_floor":
                  _model.switchCategory(FurniModel.const_44);
                  break;
               case "tab_wall":
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_297.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_584.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_463.removeGridItem(_loc2_.window);
         if(var_297 == _loc2_)
         {
            var_297 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_584.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_463.addGridItem(_loc2_.window);
            var_584.add(param1.id,_loc2_);
            if(var_297 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_55);
            if(_loc13_ == null)
            {
               return;
            }
