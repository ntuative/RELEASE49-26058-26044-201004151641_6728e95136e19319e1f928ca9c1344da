package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1245:XML;
      
      private var var_297:IGridItem;
      
      private var var_1244:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_854:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_702.length)
         {
            createLevelItem(var_702[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_854 = new PrizeViewer();
         var_702 = recycler.getPrizeTable();
         if(var_702 == null)
         {
            return;
         }
         ...
         var_1245 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_702[0].prizes.length > 0)
         {
            select(var_702[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1245) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1244) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_854.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
