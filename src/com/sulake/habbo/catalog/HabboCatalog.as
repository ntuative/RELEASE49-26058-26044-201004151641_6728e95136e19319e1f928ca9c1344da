package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_81:RecyclerLogic;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_1934:GiftWrappingConfiguration;
      ...
      private var var_1012:ClubGiftController;
      ...
      {
         return var_360.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_109.credits = _loc3_.balance;
         updatePurse();
         if(!var_1936 && var_500 != null)
         {
            var_500.playSound(HabboSoundTypesEnum.const_797);
         }
         var_1936 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_360.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = var_360.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_81 == null)
         {
            return;
         }
         var_81.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_93:
               var_1225 = param1.session.isPrivateRoom;
               if(var_81 != null)
               {
                  var_81.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_106:
               ...
               if(var_81 != null)
               {
                  var_81.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_81.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1934 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_81 != null && getCurrentLayoutCode() == "recycler")
            {
               var_81.activate();
            }
         }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1012.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      {
         var_81 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_109.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_109.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_109.isVIP = _loc2_.isVIP;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1012 == null)
         {
            var_1012 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_191 == null)
            {
               var_191 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_191.showOffer(this,param1,param2,param3,_loc7_);
      ...
      {
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_81.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_109.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_109.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_109.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_109.clubPeriods));
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_109.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1935 && var_500 != null)
         {
            var_500.playSound(HabboSoundTypesEnum.const_925);
         }
         var_1935 = false;
      }
