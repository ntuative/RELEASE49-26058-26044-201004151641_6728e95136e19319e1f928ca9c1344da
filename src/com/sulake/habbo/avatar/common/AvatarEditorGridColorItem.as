package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_751:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_684.width,var_684.height,true,0);
            _loc1_.bitmap.copyPixels(var_684,var_684.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_911.width,var_911.height,true,0);
            _loc5_ = var_911.clone();
            _loc5_.colorTransform(_loc5_.rect,var_751.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_752.width,var_752.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_752,var_752.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(var_751)
            {
               switch(var_751.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_51:
                     _loc4_.style = HabboIconType.const_582;
                     _loc4_.visible = true;
               }
            }
            else
