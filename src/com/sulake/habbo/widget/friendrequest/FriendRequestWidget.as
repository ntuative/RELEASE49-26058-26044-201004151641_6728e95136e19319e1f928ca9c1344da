package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_720,param1));
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_443,eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_410,eventHandler);
      }
      ...
      private function eventHandler(param1:RoomWidgetFriendRequestUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFriendRequestUpdateEvent.const_443:
               var_240.add(param1.requestId,new FriendRequestDialog(this,param1.requestId,param1.userId,param1.userName));
               break;
            case RoomWidgetFriendRequestUpdateEvent.const_410:
      ...
      private function removeRequest(param1:int) : void
      {
         ...
         var _loc2_:FriendRequestDialog = var_240.getValue(param1) as FriendRequestDialog;
         if(!_loc2_)
         {
            return;
         }
         _loc2_.dispose();
         var_240.remove(param1);
         checkUpdateNeed();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_443,eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_410,eventHandler);
