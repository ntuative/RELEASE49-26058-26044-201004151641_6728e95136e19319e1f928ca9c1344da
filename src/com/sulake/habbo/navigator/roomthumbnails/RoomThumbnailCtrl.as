package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this._model.mode != ThumbnailEditorModel.const_39);
         setEnabled(var_1581,this._model.mode != ThumbnailEditorModel.const_56);
         setEnabled(var_1580,this._model.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_39;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_56;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1581 = IButtonWindow(find("top_tab"));
         var_1580 = IButtonWindow(find("obj_tab"));
         var_2198 = IWindowContainer(find("tile_grid"));
         var_2199 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1581,onTopTabButton);
         Util.setProcDirectly(var_1580,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2198;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_418)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2199;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_41,HabboWindowParam.const_73,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_42,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),onImgSel,_loc10_.id));
      ...
      {
         refreshImgSelector(ThumbnailEditorModel.const_39);
         refreshImgSelector(ThumbnailEditorModel.const_56);
