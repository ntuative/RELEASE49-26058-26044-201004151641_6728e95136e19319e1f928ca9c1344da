package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1448:int = 1500;
      
      private var var_1447:int = 255;
      
      private var var_1446:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_707:
                  _loc2_.setString(RoomObjectVariableEnum.const_712,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_693:
                  _loc2_.setString(RoomObjectVariableEnum.const_519,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_567:
                  _loc2_.setString(RoomObjectVariableEnum.const_619,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_360:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_206)
                  {
                     _loc8_ = "null";
                  }
                  var_441.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_521:
                  _loc7_ = var_441.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_441.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_1008,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_827,int(_loc5_.bgOnly));
            var_1182 = _color;
            var_1447 = var_1263;
            var_984 = _loc11_;
            var_1446 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_850,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_522,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1367,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1358,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1259,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_150 || _loc13_ == RoomPlaneData.const_277)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_807)
         {
            ...
            {
               _loc7_ = var_1182 >> 16 & 255;
               _loc8_ = var_1182 >> 8 & 255;
               _loc9_ = var_1182 & 255;
               _loc10_ = var_984 >> 16 & 255;
               _loc11_ = var_984 >> 8 & 255;
               _loc12_ = var_984 & 255;
               _loc13_ = (_loc2_ - var_807) / var_1448;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1447 + (var_1446 - var_1447) * _loc13_;
               _color = _loc3_;
               var_1263 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_522,_loc3_);
         }
      }
   }
}
