package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_928:IRoomSession;
      ...
      private const const_1658:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_93,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_106,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_398,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_106:
               var_928 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_398:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_45.getValue(InventoryCategory.const_671));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_45.getValue(InventoryCategory.const_75));
      }
      ...
      {
         var_109.clubPeriods = param1;
         var_109.clubDays = param2;
         var_109.clubHasEverBeenMember = param3;
         var_109.isVIP = param4;
      ...
      {
         return PetsModel(var_45.getValue(InventoryCategory.const_148));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_936));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1658);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_45.getValue(InventoryCategory.const_295));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_253:
               _view.toggleCategoryView(InventoryCategory.const_75,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_929.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_929.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_45.getValue(InventorySubCategory.const_253));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_360 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_929.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_109.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_45.getValue(InventoryCategory.const_310) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1098 = new IncomingMessages(this);
      ...
      {
         return var_109.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_109.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_45.getValue(InventoryCategory.const_256));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_93,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_106,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_398,roomSessionEventHandler);
         ...
         var_45.add(InventoryCategory.const_310,_loc3_);
         ...
         var_45.add(InventoryCategory.const_75,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_360);
         var_45.add(InventoryCategory.const_256,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_45.add(InventoryCategory.const_671,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_360);
         var_45.add(InventoryCategory.const_295,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_45.add(InventorySubCategory.const_253,_loc8_);
         ...
         var_45.add(InventoryCategory.const_148,_loc10_);
