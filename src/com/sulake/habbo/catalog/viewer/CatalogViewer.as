package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1567:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_399 != null)
         {
            if(var_399.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_399.window);
            var_399.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1567);
         var_399 = _loc5_;
      ...
      {
         return var_399.dispatchWidgetEvent(param1);
      }
