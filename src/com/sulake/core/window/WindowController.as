package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private var var_288:Rectangle;
      
      protected var var_635:Function;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_142);
         var _loc2_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_139);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_286)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_263)
               {
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_828,this,null);
         update(this,_loc1_);
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_862;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_641 = param1;
         var_548 = !!var_641 ? uint(var_548 | var_1397) : uint(var_548 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1621 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_872:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1350:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_454:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_334:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_828:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_862:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_530:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_195:
               _loc2_ = "null";
               break;
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_915;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_424 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_7,WindowRedrawFlag.const_801);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_955 || _loc3_.hasGraphicsContext())
         {
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_548 = !!var_641 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_7,WindowRedrawFlag.const_77);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_558))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_984;
                  if(testParamFlag(WindowParam.const_341))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_201))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_201))
                  {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_171:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_168,WindowParam.const_142))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_170,WindowParam.const_139))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_427))
                        {
                           var_8.width += 0 - 0;
                        }
                  ...
                  break;
               case WindowNotifyEvent.const_395:
                  var_15.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_467);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_875,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_239,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_327:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_530,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_195,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_390:
                  var_15.invalidate(this,var_7,WindowRedrawFlag.const_1006);
                  break;
               case WindowNotifyEvent.const_391:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_358:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_15.invalidate(this,var_7,WindowRedrawFlag.const_467);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_195:
                  ...
                  break;
               case WindowNotifyEvent.const_452:
                  var_8.getRegionProperties(null,var_288);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_289:
      ...
      {
         return var_635 != null ? var_635 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_966;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_886,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_730,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_652;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_955 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_32 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_390,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_459)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_382)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_891,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_589,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
         ...
         if(var_158 && var_547 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1399,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1399,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_77);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1302,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_288 = var_8.rectangle.clone();
               var_55.x = var_7.x;
               var_55.y = var_7.y;
               var_55.width = var_7.width;
               var_55.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_422,this,var_8));
            }
            else
            {
               var_288.x = 0;
               ...
               var_288.width = 0;
               var_288.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_890,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,_param,var_15,var_7,null,var_635,properties,var_640.concat(),_id) as WindowController;
         _loc2_.var_547 = var_547;
         _loc2_.var_158 = var_158;
         _loc2_._debug = _debug;
         _loc2_.var_288 = var_288.clone();
         ...
         _loc2_.var_1120 = var_1120;
         _loc2_.var_361 = var_361;
      ...
      {
         if(var_32 == WindowState.const_365)
         {
            return true;
         }
         var_32 = WindowState.const_365;
