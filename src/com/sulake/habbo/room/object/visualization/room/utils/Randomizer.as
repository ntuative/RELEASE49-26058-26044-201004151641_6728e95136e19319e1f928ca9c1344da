package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1610:int = 16777216;
      
      public static const const_1479:int = 1;
       
      
      private var var_2362:int = 69069;
      
      private var var_1231:int = 1;
      
      private var var_2361:int = 5;
      
      private var var_1481:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1481 * param2);
      }
      ...
      {
         var _loc1_:int = var_2362 * var_1231 + var_2361;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
