package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1628:String = "room_widget";
      
      private const const_1038:String = "room_view";
      
      private var var_50:IWindowContainer;
      
      private var var_653:int = 50;
      
      private var var_2297:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_50.getChildByTag(const_1038) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_50.findChildByTag(const_1038) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
         ...
         _loc2_.offset(var_50.x,var_50.y);
         return _loc2_;
      }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_653;
               _loc2_.width = var_50.desktop.width - var_653;
               _loc2_.y = 0;
               _loc2_.height = var_50.desktop.height;
               break;
            case "RIGHT":
               _loc2_.x = 0;
               _loc2_.width = var_50.desktop.width - var_653;
            ...
            case "TOP":
               _loc2_.x = 0;
               _loc2_.width = var_50.desktop.width;
               _loc2_.y = var_653;
               _loc2_.height = var_50.desktop.height - var_653;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_50.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         var_2297 = param1.copy();
         var_50 = (param2 as ICoreWindowManager).buildFromXML(param1,0) as IWindowContainer;
         if(var_50 == null)
         {
            throw new Error("Failed to build layout from XML.");
         }
         var_50.width = var_50.desktop.width;
         var_50.height = var_50.desktop.height;
         var _loc3_:IWindowContainer = var_50.desktop as IWindowContainer;
         _loc3_.addChildAt(var_50,0);
         var _loc5_:int = 0;
         while(_loc5_ < var_50.numChildren)
         {
            _loc4_ = var_50.getChildAt(_loc5_);
            _loc6_ = false || false;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1628) == 0)
            {
         ...
         var _loc5_:IWindowContainer = var_50.getChildByTag(_loc3_) as IWindowContainer;
         if(_loc5_ == null)
         {
            return false;
         }
