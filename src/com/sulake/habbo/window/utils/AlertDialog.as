package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1089:String = "_alert_button_list";
      
      private static const const_773:String = "_alert_button_cancel";
      
      private static const const_691:String = "_alert_button_ok";
      
      private static const const_1168:String = "_alert_text_summary";
      
      private static var var_644:uint = 0;
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = _window.findChildByName(const_1089) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_691);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(_window)
         {
            ITextWindow(_window.findChildByTag("DESCRIPTION")).text = var_1380;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  if(var_180 != null)
                  {
                     var_180(this,new WindowEvent(WindowEvent.const_179,null,null));
                  }
                  break;
               case "header_button_close":
                  if(var_180 != null)
                  {
                     var_180(this,new WindowEvent(WindowEvent.const_642,null,null));
                  }
            }
         }
      }
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!_disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_691:
                  _loc2_ = _window.findChildByName(const_691) as IInteractiveWindow;
                  break;
