package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_486:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_140];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_488 != null)
         {
            ...
            {
               _loc2_ = var_488.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_140:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_488.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_687.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_335:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_488.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_687.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_537,RoomWidgetChatSelectAvatarMessage.const_609];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_537:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_140,_container.roomSession,0,"Version 26058-26044-201004151547");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_609:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_826 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_826);
            }
            if(var_486 == null)
            {
               var_487.x = 0;
               var_487.y = 0;
               var_487.z = 0;
               var_486 = _loc4_.getScreenPoint(var_487);
               var_826 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_487.x = 0;
            var_487.y = 0;
            var_487.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_487);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_486.x || _loc8_.y != var_486.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_486,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_283;
      }
