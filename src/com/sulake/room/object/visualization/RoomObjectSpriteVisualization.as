package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_280:IRoomObject;
      
      protected var var_209:int = -1;
      
      private var _updateID:int = 0;
      
      private var var_167:Array;
      
      protected var var_286:int = -1;
      
      protected var var_159:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(var_167 != null)
         {
            while(false)
            {
               _loc1_ = var_167[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_167.length > param1)
         {
            _loc2_ = var_167["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < var_167.length)
         {
