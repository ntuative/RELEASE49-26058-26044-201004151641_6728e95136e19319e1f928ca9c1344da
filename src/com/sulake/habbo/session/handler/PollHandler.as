package com.sulake.habbo.session.handler
{
   ...
   public class PollHandler extends BaseHandler
   {
      ...
      private function onPollErrorEvent(param1:PollErrorEvent) : void
      {
         ...
         _loc4_ = new RoomSessionPollEvent(RoomSessionPollEvent.const_68,_loc2_,-1);
         _loc4_.summary = "???";
      ...
      private function onPollContentsEvent(param1:PollContentsEvent) : void
      {
         ...
         _loc4_ = new RoomSessionPollEvent(RoomSessionPollEvent.const_109,_loc2_,_loc3_.id);
      ...
      private function onPollOfferEvent(param1:PollOfferEvent) : void
      {
         ...
         _loc4_ = new RoomSessionPollEvent(RoomSessionPollEvent.const_117,_loc2_,_loc3_.id);
