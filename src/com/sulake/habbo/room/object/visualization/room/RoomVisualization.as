package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1273:int = 13421772;
      
      private static const const_792:int = 16777215;
      
      public static const const_1234:int = 10066329;
      
      private static const const_791:int = 13421772;
      
      public static const const_1360:int = 16777215;
      
      private static const const_1431:int = 0;
      
      public static const const_1231:int = 16777215;
      
      private static const const_790:int = 10066329;
      
      private static const const_789:int = 10066329;
      
      public static const const_1185:int = 13421772;
       
      
      private var var_1565:int = 0;
      
      private var var_1274:String = null;
      ...
      private var var_620:Rectangle = null;
      
      private var var_2167:int = 255;
      
      private var var_2166:Boolean = false;
      
      private var var_2164:int = 255;
      
      private var var_2163:String = null;
      
      private const const_1657:int = 250;
      ...
      private var var_441:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_441 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_850);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_884);
         var _loc7_:int = 0;
         while(_loc7_ < var_77.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_192,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1231;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1185;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1357)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_220,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_620 == null)
         {
            var_620 = super.boundingRectangle;
         }
         return new Rectangle(var_620.x,var_620.y,var_620.width,var_620.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_441.maskCount)
         {
            _loc6_ = var_441.getMaskType(_loc5_);
            _loc7_ = var_441.getMaskLocation(_loc5_);
            _loc8_ = var_441.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_103.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_220 || _loc3_.type == RoomPlane.const_192 && _loc8_ == RoomPlaneBitmapMaskData.const_206)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1565;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1203)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_999 || _loc9_.y != var_1871 || _loc9_.z != var_1873 || param1.scale != var_1872))
            {
               var_999 = _loc9_.x;
               var_1871 = _loc9_.y;
               var_1873 = _loc9_.z;
         ...
         if(var_159 != _loc6_.getUpdateID())
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_1008);
            if(_loc10_ != var_2163)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_522));
            if(_loc11_ != var_1079)
            {
               var_1079 = _loc11_;
               var_2164 = var_1079 & 255;
               var_2167 = var_1079 >> 8 & 255;
               var_2162 = var_1079 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1999 + const_1657 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1999 = _loc7_;
         if(var_159 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_519);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_712);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_619);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2165 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_827));
            var_159 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_442.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_442[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_192)
            {
               if(var_2165)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_2164 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2167 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2162 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_103.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_192 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
