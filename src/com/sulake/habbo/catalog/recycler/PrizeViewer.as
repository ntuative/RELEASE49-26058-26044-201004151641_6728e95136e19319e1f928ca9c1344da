package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_251:IBitmapWrapperWindow;
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_251 != null && true)
         {
            ...
            var_251.bitmap = new BitmapData(var_251.width,var_251.height,true,16777215);
            var_251.bitmap.fillRect(var_251.bitmap.rect,16777215);
            _loc3_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_251.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
      ...
      {
         var _loc8_:* = null;
         var_251 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
