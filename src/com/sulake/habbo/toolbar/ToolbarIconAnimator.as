package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1202 = param1.loop;
         if(param1.background != null)
         {
            var_817 = getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(var_1202 == true || var_685 == 0)
         {
            if(false)
            {
               ++var_52;
               if(var_52 >= var_819.length)
               {
                  var_52 = 0;
                  ++var_685;
               }
      ...
      {
         return var_819.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1202 == false && var_685 == 1 && var_1129 != var_32;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_817 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_817.width),Math.max(param2.height,var_817.height));
            _loc3_.copyPixels(var_817,var_817.rect,new Point(0,0));
