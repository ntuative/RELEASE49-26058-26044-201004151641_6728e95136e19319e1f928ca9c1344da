package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         ...
         var_24.addHabboConnectionMessageEvent(new UserRightsMessageEvent(onUserRights));
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_75,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_671);
         _loc2_.refreshViews();
         var_10.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_174)
            {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            var_10.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.isVIP);
      ...
      {
         var _loc2_:* = null;
         if(var_10.isInventoryCategoryInit(InventoryCategory.const_310))
         {
            _loc2_ = var_10.marketplaceModel;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_148);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_10.setInventoryCategoryInit(InventoryCategory.const_295);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_75);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_10.toggleInventorySubPage(InventorySubCategory.const_253);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_10.setInventoryCategoryInit(InventoryCategory.const_256);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_310);
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
