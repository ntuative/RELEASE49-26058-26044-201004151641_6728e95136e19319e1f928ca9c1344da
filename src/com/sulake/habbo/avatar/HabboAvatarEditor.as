package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_870:AvatarEditorHandler;
      ...
      private const const_1096:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_718.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_161)
         {
            ...
            var_518["null"] = new FigureData(this);
            var_518["null"] = new FigureData(this);
            _loc1_ = var_518["null"];
            _loc2_ = var_518["null"];
            ...
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_87);
            var_86 = new Map();
            var_426 = new Map();
            var_86.add(AvatarEditorFigureCategory.const_849,new BodyModel(this));
            var_86.add(AvatarEditorFigureCategory.const_49,new HeadModel(this));
            var_86.add(AvatarEditorFigureCategory.const_301,new TorsoModel(this));
            var_86.add(AvatarEditorFigureCategory.const_1348,new LegsModel(this));
            var_86.add(AvatarEditorFigureCategory.const_1285,new HotLooksModel(this));
            var_426.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_426.add(AvatarEditorSideCategory.const_370,new ClubPromoModel(this));
            var_161 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1044 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1522;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1044 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1096)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1609.clone() as IWindowContainer,param1,_loc14_);
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1382.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1282)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1044 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1382.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_426.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_870 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_718.getPalette(param1);
      }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_86.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = var_426.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_41,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_849);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_718 = var_605.getFigureData(AvatarType.const_85);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_605 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1044 = param3;
         var _loc4_:FigureData = var_518[param2];
         if(_loc4_ == null)
         {
            return;
         }
