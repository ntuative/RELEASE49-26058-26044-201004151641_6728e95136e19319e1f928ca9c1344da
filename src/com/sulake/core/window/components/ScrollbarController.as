package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1077:String = "increment";
      
      private static const const_490:String = "slider_bar";
      
      private static const const_1076:String = "decrement";
      
      private static const const_769:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_158 = false;
         var_20 = param12;
         _horizontal = param2 == WindowType.const_458;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_422)
         {
            if(var_20 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_769) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_20 != null && true)
         {
            IWindow(var_20).removeEventListener(WindowEvent.const_46,onScrollableResized);
         }
         var_20 = param1;
         if(var_20 != null && true)
         {
            IWindow(var_20).addEventListener(WindowEvent.const_46,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_846 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_846 != null)
         {
            _loc1_ = findParentByName(var_846) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_846) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1077)
            {
               if(var_20)
               {
                  var_592 = true;
            ...
            else if(param2.name == ScrollbarController.const_1076)
            {
               if(var_20)
               {
                  var_592 = true;
            ...
            else if(param2.name == ScrollbarController.const_769)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_899)
         {
