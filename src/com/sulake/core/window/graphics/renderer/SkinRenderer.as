package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_326:Dictionary;
      
      protected var var_327:Dictionary;
      ...
      {
         super();
         var_326 = new Dictionary();
         var_327 = new Dictionary();
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_327)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_327[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_326[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_455[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_455[_loc1_]).dispose();
         ...
         {
            ISkinTemplate(var_326[_loc1_]).dispose();
