package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_343:String = "_DROPMENU_TITLETEXT";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_128 = context.create(name + "::submenu","",WindowType.const_461,var_78,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_1025)
         {
            if(param2 == var_128)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_389,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_316,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_510 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_510).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_599)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_509,getSubMenu(),subMenuEventProc);
                  var_599 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_454,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_510 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_334,this,null));
         }
      }
      ...
      {
         return getChildByName(DropMenuController.const_343) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_599 = false;
            getTitleText().text = var_510 < var_509.length && var_510 > -1 ? "null" : caption;
         }
      }
   }
}
