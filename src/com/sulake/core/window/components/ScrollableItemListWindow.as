package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_800:IItemListWindow;
      
      private var var_336:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_70))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_336)
         {
            var_336 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_336)
            {
               var_336.addEventListener(WindowEvent.const_258,scrollBarEventProc);
               var_336.addEventListener(WindowEvent.const_214,scrollBarEventProc);
            }
         }
         return var_336;
      }
      ...
      override public function dispose() : void
      {
         if(var_336)
         {
            var_336.removeEventListener(WindowEvent.const_258,scrollBarEventProc);
            var_336.removeEventListener(WindowEvent.const_214,scrollBarEventProc);
            var_336 = null;
         }
         if(var_800)
         {
      ...
      {
         if(param1.type == WindowEvent.const_258)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_214)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_800)
         {
            var_800 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_800;
      }
