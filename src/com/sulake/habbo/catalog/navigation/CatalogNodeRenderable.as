package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1079:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1485:XML;
      
      private static var var_1484:XML;
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_36,onIconImageReady);
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1380;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1485) as IWindowContainer;
         }
         else
         {
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(var_48);
            }
         }
         if(var_48 != null)
         {
      ...
      {
         var_48 = navigator.catalog.windowManager.buildFromXML(var_1484) as IItemListWindow;
         if(var_48 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1235;
            }
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(var_48);
            }
         }
         if(var_48 != null)
         {
