package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_215 is FloorItem ? 1 : 2;
         var_2119 = _loc2_;
         var_2120 = var_215.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_215.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1554,var_1553);
         }
      }
      ...
      {
         if(param1 != var_2119 || param2 != var_2120)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1941);
      }
      ...
      {
         if(var_47 != null && false && var_215 != null)
         {
            var_47.furniModel.removeLockFrom(var_215.id);
            var_215 = null;
         }
      }
