package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1181));
      ...
      public function show() : void
      {
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_283.width,var_283.height);
         var_283.x = _loc2_.x;
         var_283.y = _loc2_.y;
