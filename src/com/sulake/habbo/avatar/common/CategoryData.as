package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_725 >= 0 && var_172.length > var_725)
         {
            _loc2_ = var_172[var_725];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_172.length > param1)
         {
            _loc3_ = var_172[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = var_233[0] as Array;
         ...
         {
            _loc7_ = var_233[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > var_197[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_197[param2],param2);
         var_197[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_197[param1])
         {
            return null;
         }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_233.length <= param1)
         {
            return null;
         }
         return var_233[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_172[var_725] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_233)
         {
            for each(_loc2_ in var_233 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_197 = new Array(param1.length);
         var _loc3_:int = 0;
