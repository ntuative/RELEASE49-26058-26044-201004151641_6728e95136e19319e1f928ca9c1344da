package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_909:String = "issue_bundle_open";
      
      public static const const_726:String = "issue_bundle_my";
      
      public static const const_962:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_118 = new Map();
         var_776 = new Map();
         var_551 = new IssueBrowser(this,var_56.windowManager,var_56.assets);
         var_647 = [];
         var_775 = [];
         var_956 = new Map();
      }
         ...
         for each(_loc4_ in var_118)
         {
            switch(param1)
            {
               case const_909:
                  ...
                  break;
               case const_726:
                  if(_loc4_.state == IssueMessageData.const_420 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      {
         var _loc2_:IssueBundle = var_118.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_776.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_118.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_118.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_776.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1180)
         {
            var_148.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_118)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_776.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_776.add(param1.issueId,_loc2_);
            var_118.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         ...
         if(param1.state == IssueMessageData.const_146)
         {
            ...
            _loc8_ = var_775.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_420 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_775 = var_775.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_118.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_118.getValues();
         for each(_loc3_ in _loc1_)
         {
            if(_loc3_.state == IssueMessageData.const_146 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_56.soundManager.playSound(HabboSoundTypesEnum.const_873);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_776.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_118.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_118.getValues();
         var _loc4_:int = var_56.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_420 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
