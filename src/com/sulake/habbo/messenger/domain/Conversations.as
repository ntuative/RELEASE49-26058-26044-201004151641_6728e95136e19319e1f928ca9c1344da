package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1357:int = 1;
       
      
      private var _closedConversations:Array;
      
      private var var_447:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(false)
         {
            var_135[0].setSelected(true);
         }
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_527,0,var_447.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_447.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_447.getTabCount());
      ...
      {
         return var_447.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function closeConversation() : void
      {
         ...
         var _loc2_:int = var_135.indexOf(_loc1_);
         Util.remove(var_135,_loc1_);
         ...
         while(_loc2_ >= 0)
         {
            if(false)
            {
               var_135[_loc2_].setSelected(true);
               break;
            }
            _loc2_--;
         }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         var _loc2_:int = var_135.indexOf(param1);
         while(_startIndex + var_447.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_447.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_613,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function setFollowingAllowedAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_.selected)
         {
            var_447.refresh(false);
         }
      }
      
      public function addTestUser() : void
      {
         this.addConversation(var_1357++);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_447.addMsgToView(_loc3_,param1);
         if(_loc2_ != var_135.length || _loc4_ != _loc3_.newMessageArrived)
         {
            var_447.refresh(false);
         }
      }
