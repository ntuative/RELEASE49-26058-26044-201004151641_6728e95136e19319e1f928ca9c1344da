package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_752:int = 31536000;
      
      private static const const_750:int = 86400;
      
      private static const const_749:int = 3600;
      
      private static const const_751:int = 60;
      ...
      {
         if(param1 < 2 * const_751)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_749)
         {
            return Math.round(param1 / const_751) + " mins ago";
         }
         if(param1 < 2 * const_750)
         {
            return Math.round(param1 / const_749) + " hours ago";
         }
         if(param1 < 2 * const_752)
         {
            return Math.round(param1 / const_750) + " days ago";
         }
         return Math.round(param1 / const_752) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_937,_data.userId),_callerFrame,var_971,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_791.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_791.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1303),_callerFrame,var_971,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_971,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1303),_callerFrame,var_971,false,true);
      }
