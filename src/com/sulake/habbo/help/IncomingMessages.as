package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(false)
         {
            var_21.tutorialUI.onChangeUserNameResult(param1);
         }
         if(false)
         {
            var_21.hotelMergeUI.onChangeUserNameResult(param1);
         }
      }
      ...
      private function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(false)
         {
            var_21.tutorialUI.onCheckUserNameResult(param1);
         }
         if(false)
         {
            var_21.hotelMergeUI.onCheckUserNameResult(param1);
         }
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:FaqIndex = var_21.getFaq();
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            var_21.tellUI(HabboHelpViewEnum.const_200,_loc4_);
         }
      }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         if(_userId != _loc2_.method_7)
         {
            return;
         }
         var_21.ownUserName = _loc2_.newName;
         if(false)
         {
            var_21.tutorialUI.onUserNameChanged(_loc2_.newName);
         }
         if(false)
         {
            var_21.hotelMergeUI.onUserNameChanged(_loc2_.newName);
         }
      }
      ...
      private function onRoomEntryInfo(param1:IMessageEvent) : void
      {
         ...
         {
            var_21.enableCallForGuideBotUI();
         }
         else
         {
            var_21.disableCallForGuideBotUI();
         }
      }
      ...
      private function onCallForHelpResult(param1:IMessageEvent) : void
      {
         ...
         var_21.showCallForHelpResult(_loc4_);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_265,_loc6_);
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         var_21.tutorialUI.onUserChanged();
      }
      ...
      private function onCallForHelpReply(param1:IMessageEvent) : void
      {
         ...
         var_21.showCallForHelpReply(_loc2_.message);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         var_21.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + getCloseReasonKey(_loc3_.closeReason) + "}",0,onAlertClose);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_141);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _userId = _loc2_.id;
         var_21.ownUserName = _loc2_.name;
      }
      
      private function onPendingCallsForHelpDeleted(param1:IMessageEvent) : void
      {
         var_21.showUI(HabboHelpViewEnum.const_322);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         var_21.updateTutorial(_loc2_.hasChangedLooks,_loc2_.hasChangedName,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         var_21.userRegistry.registerRoom(var_21.localization.getKey(_loc3_));
      }
      ...
      private function onGuestRoomResult(param1:IMessageEvent) : void
      {
         ...
         var_21.userRegistry.registerRoom(_loc2_.data.roomName);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_481);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_629);
         var_21.tellUI(HabboHelpViewEnum.const_629,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_299)
            {
               var_21.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
         ...
         var_21.tellUI(HabboHelpViewEnum.const_583);
      }
