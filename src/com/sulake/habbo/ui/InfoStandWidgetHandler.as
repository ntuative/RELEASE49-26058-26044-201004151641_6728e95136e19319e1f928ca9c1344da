package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_128,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_144,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_137,onPetInfo);
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_128,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_144,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_137,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_31:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_626);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_293);
                  if(param1.category == RoomObjectCategoryEnum.const_33)
                  {
                     _loc23_ = _container.sessionDataManager.getFloorItemData(_loc22_);
                  }
                  else if(param1.category == RoomObjectCategoryEnum.const_31)
                  {
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1021);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_819);
               _loc6_.expiration = _loc9_ - (getTimer() - _loc10_) / 60000;
               _loc6_.isWallItem = param1.category == RoomObjectCategoryEnum.const_31;
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_335)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_908)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_225)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_229)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_575);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1315;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_975;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1017;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1296);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_55,_loc18_);
               if(_loc19_ != null)
               {
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_55,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_606.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_55);
            var_606.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_575);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_115];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_695);
         _loc1_.push(RoomWidgetUserActionMessage.const_660);
         _loc1_.push(RoomWidgetFurniActionMessage.const_266);
         _loc1_.push(RoomWidgetFurniActionMessage.const_607);
         _loc1_.push(RoomWidgetFurniActionMessage.const_603);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_578);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_675);
         _loc1_.push(RoomWidgetUserActionMessage.const_477);
         _loc1_.push(RoomWidgetUserActionMessage.const_683);
         _loc1_.push(RoomWidgetUserActionMessage.const_643);
         _loc1_.push(RoomWidgetUserActionMessage.const_1280);
         _loc1_.push(RoomWidgetPetCommandMessage.const_604);
         _loc1_.push(RoomWidgetPetCommandMessage.const_722);
         _loc1_.push(RoomWidgetUserActionMessage.const_585);
         _loc1_.push(RoomWidgetUserActionMessage.const_423);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_115:
      ...
      public function dispose() : void
      {
         ...
         if(var_606 != null)
         {
            _loc1_ = var_606.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_606.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_477)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_605:
               ...
               break;
            case RoomWidgetUserActionMessage.const_585:
               _container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_702:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_920,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_531:
               ...
               break;
            case RoomWidgetUserActionMessage.const_695:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_675:
               ...
               break;
            case RoomWidgetUserActionMessage.const_477:
