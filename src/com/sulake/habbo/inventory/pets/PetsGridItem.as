package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc7_:IAvatarImage = param5.createPetImageFromFigure(param2.figure,AvatarScaleType.const_55);
         if(_loc7_ == null)
         {
            return;
         }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_53:
               var_1107.setSelectedGridItem(this);
               var_936 = true;
               break;
            case WindowMouseEvent.const_100:
               var_936 = false;
               break;
            case WindowMouseEvent.const_32:
               ...
               {
                  var_936 = false;
                  var_1107.placePetToRoom(var_1190.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1632) : uint(const_1633);
      }
