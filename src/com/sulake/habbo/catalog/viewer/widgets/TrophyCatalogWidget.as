package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_498:String = "g";
      
      private var var_190:int = 0;
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_412.getWithIndex(var_190);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_498);
            if(_loc3_ == null)
            {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_79 != null)
         {
            ...
            var_79.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
            var_79.invalidate();
         }
      ...
      override public function init() : void
      {
         ...
         var _loc8_:* = null;
         super.init();
         var_79 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_412.getValue(_loc6_) == null)
            {
               var_412.add(_loc6_,new Map());
            }
            _loc8_ = var_412.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_412.getWithIndex(var_190);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_498);
            if(_loc3_ == null)
            {
