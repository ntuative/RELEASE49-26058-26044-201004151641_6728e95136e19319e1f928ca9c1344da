package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_298:String = "pets";
      ...
      private var var_651:IWindowContainer;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_224,onObjectPlaced);
         var_459 = new Timer(const_1037,1);
         ...
         _view.switchCategory(const_44);
      }
      
      public function get isTradingOpen() : Boolean
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_253;
      }
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc8_:int = 0;
         var _loc6_:Array = [const_44,const_45];
         var _loc7_:int = 0;
      ...
      public function method_1(param1:int, param2:String = null) : GroupItem
      {
         if(param2 == null)
         {
            param2 = "null";
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_385.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_385.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_535)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_224,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_119 != null)
            {
               var_119.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_119.stop();
               var_119 = null;
            }
            if(var_651 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_174)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_302)
         {
         ...
         else if(param3 == FurniCategory.const_318)
         {
         ...
         if(var_651 == null)
         {
            var_651 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_651.clone() as IWindowContainer;
      ...
      public function removeAllLocks() : void
      {
         ...
         var _loc3_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_44,const_45];
         var _loc6_:int = 0;
      ...
      {
         var _loc1_:GroupItem = method_1(getSelectedItemIndex(),_view.visibleCategoryId);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_253:
               ...
               break;
            case InventorySubCategory.const_982:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_119 = new Timer(param1,1);
            var_119.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_119.start();
         }
         else
         {
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_310);
      ...
      {
         if(param1 == InventoryCategory.const_75 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_298:
                  var_47.toggleInventoryPage(InventoryCategory.const_148);
            }
         }
      }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = getCategoryContent(const_45);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc8_:Array = [const_44,const_45];
         var _loc9_:int = 0;
      ...
      {
         if(var_780 && param1.type == RoomEngineObjectEvent.const_224)
         {
            var_47.showView();
            var_780 = false;
         }
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_44,const_45];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
      ...
      public function removeFurni(param1:int) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         var _loc7_:Array = [const_44,const_45];
         var _loc8_:int = 0;
      ...
      {
         var _loc2_:GroupItem = method_1(getSelectedItemIndex(),_view.visibleCategoryId);
         if(_loc2_ == null)
         {
            return false;
         }
         ...
         if(_loc3_.category == FurniCategory.const_318 || _loc3_.category == FurniCategory.const_302 || _loc3_.category == FurniCategory.const_317)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_385 = new Map();
         var_385.add(const_44,new Array());
         var_385.add(const_45,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
