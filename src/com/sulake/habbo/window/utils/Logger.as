package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1589:ICoreWindowManager;
      ...
      {
         var_1589 = param2 as ICoreWindowManager;
         _window = var_1589.create("Logger::Output",HabboWindowType.const_448,WindowStyle.const_282,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_363 = var_1589.create("Logger::Output::Text",HabboWindowType.const_4,WindowStyle.const_282,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
