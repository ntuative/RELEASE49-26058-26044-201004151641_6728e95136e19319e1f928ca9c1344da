package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1398:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2285:int = -1;
      ...
      protected var var_1561:String = null;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1561 != null && var_1561.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2285,param1);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_834:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_953:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_1896 != param1 || var_1897 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1895 != param1 || var_1898 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2285 = _loc3_.getNumber(RoomObjectVariableEnum.const_218);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_230));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1561 = _loc3_.getString(RoomObjectVariableEnum.const_288);
