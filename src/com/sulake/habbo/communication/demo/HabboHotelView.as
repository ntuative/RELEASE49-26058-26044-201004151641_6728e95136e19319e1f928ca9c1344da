package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_617:Function;
      
      private var _window:IWindowContainer;
      
      private var var_744:IAssetLibrary;
      
      private var var_898:uint = 0;
      
      private var var_618:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_744.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.const_36)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_433));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_744.loadAssetFromFile("hotel_view_banner_" + var_898,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_739));
            }
            var_618 = param2;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_744.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
