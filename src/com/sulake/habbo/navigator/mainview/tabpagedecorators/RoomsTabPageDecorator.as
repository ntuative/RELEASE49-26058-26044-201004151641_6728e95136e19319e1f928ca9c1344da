package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_257,Tabs.const_303);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_257,Tabs.const_551);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_257,Tabs.const_303,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_457 == null)
         {
            var_457 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_457.procedure = onChangeFilter;
