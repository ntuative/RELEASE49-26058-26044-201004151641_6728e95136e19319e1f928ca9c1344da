package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_835:BitmapData = null;
      ...
      private var var_836:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_355,0,0,_loc4_,var_1471,var_836,var_835));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1913 = int(_config.getKey("interstitial.interval","30000"));
         var_1914 = int(_config.getKey("interstitial.show.time","5000"));
         var_1470 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1218 = _loc2_.imageUrl;
         var_1471 = _loc2_.clickUrl;
         if(var_1218 != "" && var_1471 != "")
         {
            _loc3_ = var_1218;
            ...
            _loc4_ = new URLRequest(var_1218);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1219 = _loc2_.imageUrl;
         var_1915 = _loc2_.clickUrl;
         var_692 = getTimer();
         if(var_1219 != "")
         {
            _loc3_ = var_1219;
            ...
            var_221.start();
            _loc4_ = new URLRequest(var_1219);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_469,0,0,param1.bitmapData,var_1915));
            var_692 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_835 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1470 > 0 && var_1469 >= var_1470)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_692;
         if(_loc1_ > var_1913)
         {
            ++var_1469;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_435));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_836 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
