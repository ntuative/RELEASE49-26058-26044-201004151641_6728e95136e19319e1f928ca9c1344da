package com.hurlant.math
{
   ...
   class BarrettReduction implements IReduction
   {
      ...
      private var var_1721:BigInteger;
      ...
      function BarrettReduction(param1:BigInteger)
      {
         ...
         r2 = new BigInteger();
         q3 = new BigInteger();
         BigInteger.const_134.dlShiftTo(2 * param1.t,r2);
         var_1721 = r2.divide(param1);
         this.m = param1;
      }
      ...
      public function reduce(param1:BigInteger) : void
      {
         ...
         var_1721.multiplyUpperTo(r2,NaN,q3);
         m.multiplyLowerTo(q3,NaN,r2);
         while(_loc2_.compareTo(r2) < 0)
         {
            _loc2_.method_2(1,NaN);
         }
