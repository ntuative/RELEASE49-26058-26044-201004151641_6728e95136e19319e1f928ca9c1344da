         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               if(param1 is RoomObjectAvatarUpdateMessage)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_328,_loc3_.dirHead);
                  }
               }
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  _loc4_ = param1 as RoomObjectAvatarFigureUpdateMessage;
                  _loc5_ = _loc2_.getString(RoomObjectVariableEnum.const_154);
                  _loc2_.setString(RoomObjectVariableEnum.const_154,_loc4_.figure);
                  _loc2_.setString(RoomObjectVariableEnum.const_1212,_loc4_.race);
               }
               ...
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_485,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_439,getTimer());
               }
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  _loc9_ = param1 as RoomObjectAvatarChatUpdateMessage;
                  _loc2_.setNumber(RoomObjectVariableEnum.const_596,_loc9_.numberOfWords);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_594,new Date().valueOf());
               }
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  _loc10_ = param1 as RoomObjectAvatarPostureUpdateMessage;
                  _loc2_.setString(RoomObjectVariableEnum.const_244,_loc10_.postureType);
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_805,Number(getTimer()));
                  _loc2_.setNumber(RoomObjectVariableEnum.const_847,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
