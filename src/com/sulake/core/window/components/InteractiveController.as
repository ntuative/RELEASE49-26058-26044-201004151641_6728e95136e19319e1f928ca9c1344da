package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2287:uint = 0;
      
      protected var var_948:String = "";
      
      protected var var_452:Array;
      
      protected var var_949:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_452 = new Array();
         var_452[0] = MouseCursorType.const_336;
         var_452[1] = MouseCursorType.const_41;
         var_452[2] = MouseCursorType.const_336;
         var_452[3] = MouseCursorType.const_336;
         var_452[4] = MouseCursorType.const_41;
         var_452[5] = MouseCursorType.const_41;
         var_452[6] = MouseCursorType.const_336;
         if(var_328 == null)
         {
            var_328 = new Array();
            var_328[0] = WindowState.const_99;
            var_328[1] = WindowState.const_78;
            var_328[2] = WindowState.const_83;
            var_328[3] = WindowState.const_69;
            var_328[4] = WindowState.WINDOW_STATE_SELECTED;
            var_328[5] = WindowState.const_98;
            var_328[6] = WindowState.const_70;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1026,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_743));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_956,param1.toolTipDelay != const_1399));
         return param2;
      }
      ...
      {
         var_948 = param1 == null ? const_743 : param1;
      }
      ...
      public function getMouseCursorByState(param1:uint) : uint
      {
         ...
         while(_loc2_-- > 0)
         {
            if((param1 & 0) > 0)
            {
               return var_452[_loc2_];
            }
         }
         return MouseCursorType.const_41;
      }
