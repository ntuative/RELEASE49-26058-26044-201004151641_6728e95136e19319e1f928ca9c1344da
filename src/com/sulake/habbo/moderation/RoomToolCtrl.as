package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_981:ICheckBoxWindow;
      ...
      private var var_667:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_520,_data.flatId),var_52,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_667.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1308,_loc2_,var_434.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_981.isSelected,var_982.isSelected,var_667.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1333);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1172);
      }
      
      public function populate() : void
      {
         var_48 = IItemListWindow(var_52.findChildByName("list_cont"));
         ...
         var_667 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_981 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
         var_982 = ICheckBoxWindow(var_52.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_401));
