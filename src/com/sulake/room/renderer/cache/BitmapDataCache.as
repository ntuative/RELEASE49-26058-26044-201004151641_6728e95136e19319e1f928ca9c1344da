package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         var _loc3_:BitmapDataCacheItem = var_343.getValue(param1) as BitmapDataCacheItem;
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.bitmapData;
            if(_loc4_ != null)
            {
               var_475 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         else
         {
            ...
            var_343.add(param1,_loc3_);
            var_342.push(_loc3_);
         }
         var_475 += param2.width * param2.height * 4;
      }
      ...
      public function compress() : void
      {
         ...
         if(memUsage > memLimit)
         {
            ...
            var_342.splice(_loc2_,0 - _loc2_);
            if(memUsage > memLimit)
            {
               var_342.sortOn("memUsage",Array.NUMERIC);
      ...
      {
         var _loc2_:BitmapDataCacheItem = var_343.getValue(param1) as BitmapDataCacheItem;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function removeItem(param1:BitmapDataCacheItem) : void
      {
         ...
         param1 = var_343.remove(param1.name) as BitmapDataCacheItem;
         if(param1 != null)
         {
            var_475 -= param1.memUsage;
            param1.dispose();
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_343 != null)
         {
            ...
            {
               _loc2_ = var_343.getWithIndex(_loc1_) as BitmapDataCacheItem;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
