package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_349:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1078:uint = 1;
       
      
      private var var_672:ISkinContainer;
      ...
      private var var_1234:ProfilerAgentTask;
      
      private var var_1233:IEventDispatcher;
      
      private var var_2385:uint = 0;
      
      private var var_1236:ProfilerAgentTask;
      
      private var var_1235:ProfilerOutput;
      
      private var var_701:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1233 = Component(param1).events;
         var_417 = new Array();
      ...
      {
         return var_226[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_226[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_672 = new SkinContainer(_loc3_.content as XML,assets);
         var_701 = new WindowRenderer(var_672);
         var_226 = new Array(const_349);
         var _loc5_:int = 0;
         while(_loc5_ < const_349)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_701,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_226[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_226[const_1078];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_336,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1179,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_226[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_226.pop()).dispose();
            }
            var_226 = null;
            while(false)
            {
      ...
      {
         return var_226[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_417[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_417[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1235 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1235 = new ProfilerOutput(_loc3_,this,var_701);
               var_1234 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1234);
               var_1236 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1236);
               var_1021 = true;
            }
         }
      }
      ...
      {
         return var_672.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_937.length > 0)
         {
            var_1233.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_349 - 1;
            while(_loc2_ >= 0)
            {
               var_226[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1021)
         ...
         var_1233.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_349)
         {
            var_226[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1021)
         {
         ...
         if(WindowContext.var_937.length > 0)
         {
            WindowContext.var_937.flush();
         }
         if(WindowContext.var_1381.length > 0)
         {
            WindowContext.var_1381.flush();
         }
         var_1233.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1268,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1218,param2.name + ": " + param2.toString());
            }
