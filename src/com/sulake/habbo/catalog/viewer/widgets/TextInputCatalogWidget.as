package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1087:ITextFieldWindow;
      ...
      {
         super.init();
         var_1087 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1087 != null)
         {
            var_1087.addEventListener(WindowKeyboardEvent.const_635,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1087.text));
      }
   }
}
