package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_716);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_720);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_113:
            ...
            case FriendRequestEvent.const_271:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_716:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_720:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_113);
         _loc1_.push(FriendRequestEvent.const_57);
         _loc1_.push(FriendRequestEvent.const_271);
         return _loc1_;
      }
