package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
            ...
            case "info_pixels":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openInventoryCategory(InventoryCategory.const_295);
                     break;
                  case "ctlg_text_7":
            ...
            case "club1":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openCatalogPage(CatalogPageName.const_202,true);
               }
               break;
            default:
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         _loc8_.addEventListener(AssetLoaderEvent.const_36,onCatalogImageReady);
      }
