package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_84 * param1.x - var_83 * param1.z;
      ...
      {
         return Math.sqrt(var_83 * var_83 + _y * _y + var_84 * var_84);
      }
      ...
      {
         return var_83 * param1.x + _y * param1.y + var_84 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_83 + "," + _y + "," + var_84 + "," + var_1069 + ")";
      }
