package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_1147:XML;
      
      private var var_297:IWindowContainer;
      
      private var var_398:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_398.destroyGridItems();
         var_297 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1147) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_794.width,var_794.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_662.width,var_662.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_662,var_662.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_398.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_398.numGridItems)
         {
            return;
         }
         select(var_398.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_794 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         var_662 = BitmapData(_loc3_.content);
      }
