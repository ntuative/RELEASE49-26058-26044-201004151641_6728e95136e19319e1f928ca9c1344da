package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_774:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         var_774 = new UserCountRenderer(_navigator);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1128 != null)
         {
            _loc2_ = var_1128.tags[0];
            var_1128.color = getBgColor(_loc2_);
         }
         var_1128 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_376 = IScrollbarWindow(var_19.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_1633 - _loc2_.stageX);
         var_1633 = _loc2_.stageX;
         var_1634 = _loc3_ > 2;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_48.numListItems)
         {
            if(var_48.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_48.getListItemAt(param2));
      ...
      private function refreshFavouriteIcon(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         refreshRegion(param1,"favourite",_loc3_ && !_loc4_,method_9);
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_160,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_133,null,0);
         refreshRoomName(param1,param2);
         var_774.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_262)
         {
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_133:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_160:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1278,true);
