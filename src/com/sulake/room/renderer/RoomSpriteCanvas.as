package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_781:int = 50;
      ...
      private var var_232:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_2087:Number = -10000000;
      
      private var var_2088:Number = -10000000;
      
      private var var_2364:int = 0;
      
      private var var_524:RoomObjectCache;
      
      private var var_724:int;
      
      private var var_267:Sprite;
      
      private var var_1053:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_232 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
      ...
      public function update() : void
      {
         if(var_1054 == 0)
         {
            checkMouseHits(var_1052.x,var_1052.y,MouseEvent.MOUSE_MOVE);
         }
         var_1054 = 0;
         ++var_1530;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_53.graphics.beginFill(var_2364);
      ...
      {
         var _loc11_:Number = param1 - var_724 / 2;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_724 != var_2091 || var_723 != var_2089)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_430.sortOn("z",0 | 0);
         if(_loc6_ < var_430.length)
         {
            var_430.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_430[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_875.push(_loc12_ - _loc2_);
         if(var_875.length == const_781)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_781)
            {
               _loc13_ += var_875[_loc14_];
               _loc14_++;
            }
            var_875 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_523.length)
            {
               cleanSprite(var_523[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_523 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_309 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_309.getKey(_loc1_);
            _loc3_ = var_309.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1053 != null)
                  {
                     var_1053.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1530,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_232.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_232.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_430.length)
         {
            return null;
         }
         return var_430[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_522.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_522.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2087 || param2 != var_2088)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_522.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_522.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_523.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_232.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_232.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_232.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_232.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_524.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_524.getObjectCache(param2);
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_724 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_723))
                  {
