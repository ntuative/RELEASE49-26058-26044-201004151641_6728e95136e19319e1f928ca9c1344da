package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1184:IProductData;
      ...
      {
         super();
         var_1185 = param1.productType;
         var_1186 = param1.furniClassId;
         var_986 = param1.extraParam;
         var_985 = param1.productCount;
         var_1183 = param1.expiration;
         var_1184 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_80:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_986);
               break;
