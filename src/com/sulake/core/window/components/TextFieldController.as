package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_840:Boolean = false;
      ...
      private function onRemovedEvent(param1:Event) : void
      {
         ...
         {
            var_15.handleError(WindowContext.ERROR_DURING_EVENT_HANDLING,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_954,PropertyStruct.const_62,var_954 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_840 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               var_954 = _loc2_.value as Boolean;
               if(var_954)
               {
