package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1663:int = 3;
      
      public const const_1530:int = 2;
      ...
      private var var_2122:MarketplaceItemStats;
      ...
      private var var_191:MarketplaceConfirmationDialog;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1550,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2119 || param1.furniTypeId != var_2120)
         {
            return;
         }
         var_2122 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_200.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1530,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_200.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_200.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_414)
            {
               var_200.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2123 = _loc3_.creditsWaiting;
         var_200 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_200.add(_loc4_.offerId,_loc6_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_191)
         {
            var_191 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_191.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2124,var_2121,var_2077,var_2125);
      }
