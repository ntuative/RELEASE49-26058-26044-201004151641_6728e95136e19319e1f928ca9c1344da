package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1421:uint = 13232628;
      
      private static var var_1722:uint = 11129827;
      ...
      private var var_565:IWindowContainer;
      
      private var var_796:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_47.localization.registerParameter("help.tutorial.name.available","name",var_337);
      ...
      private function showSelectionView() : void
      {
         if(!var_565)
         {
            var_565 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_565)
            {
               return;
            }
            _window.content.addChild(var_565);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_246)
         {
            var_246 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_246)
            {
               return;
            }
            _window.content.addChild(var_246);
         }
         _window.caption = var_47.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_246.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_337;
         }
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1171 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_796 = new NameSuggestionListRenderer(var_47);
         var _loc6_:int = var_796.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1421;
