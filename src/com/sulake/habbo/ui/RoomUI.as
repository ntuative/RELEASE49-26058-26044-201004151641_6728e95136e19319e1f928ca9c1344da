package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_859:IHabboHelp;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1039 = RoomDesktop.const_460;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.sessionDataManager = var_360;
         _loc3_.roomSessionManager = var_18;
         _loc3_.friendList = _friendList;
         _loc3_.avatarRenderManager = var_605;
         _loc3_.inventory = var_10;
         _loc3_.toolbar = var_187;
         _loc3_.navigator = _navigator;
         _loc3_.avatarEditor = var_1260;
         _loc3_.catalog = _catalog;
         _loc3_.adManager = var_265;
         _loc3_.localization = _localization;
         _loc3_.habboHelp = var_859;
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_306:
            ...
            case RoomSessionEvent.const_106:
               if(param1.session != null)
               {
                  ...
                  var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_164,HabboToolbarIconEnum.ZOOM));
                  var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_164,HabboToolbarIconEnum.MEMENU));
                  var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_164,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_265 != null && false)
         {
            var_265.events.addEventListener(AdEvent.const_435,adEventHandler);
            var_265.events.addEventListener(AdEvent.const_469,adEventHandler);
            var_265.events.addEventListener(AdEvent.const_355,adEventHandler);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_859 != null)
         {
            var_859.release(new IIDHabboHelp());
            var_859 = null;
         }
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_460)
            {
               var_1039 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_554:
               _loc5_ = false;
               ...
               if(var_1039 != RoomDesktop.const_460)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_250,var_1039);
               }
               if(var_265 != null)
               {
                  var_265.showRoomAd();
               ...
               break;
            case RoomEngineEvent.const_617:
               disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_690:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_507:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_524:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_727,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_554,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_617,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_67,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_690,roomEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_725,roomObjectEventHandler);
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            var_18.events.addEventListener(RoomSessionEvent.const_306,roomSessionStateEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionChatEvent.const_140,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionUserBadgesEvent.const_115,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_104,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_119,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_57,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPresentEvent.const_264,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_941,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_986,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_194,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_634,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_507,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_178,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_524,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_663,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_362,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionPollEvent.const_117,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_368,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionFriendRequestEvent.const_113,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_727)
         {
            if(var_18 != null)
            {
               var_18.roomEngineReady = true;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1260 = param2 as IHabboAvatarEditor;
      }
   }
}
