package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureShadowVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2286:Number = NaN;
      ...
      private function updateSprites(param1:int, param2:Number) : void
      {
         ...
         if(_loc5_ != null)
         {
            if(_loc4_ != null && _loc4_.asset != null)
            {
               ...
               {
                  _loc6_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_230);
               }
               _loc5_.alpha = _loc6_;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_286 != _loc3_.getUpdateID() || param1 != var_209 || param2 != var_2286)
         {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc4_ || var_209 != param1.scale)
         {
