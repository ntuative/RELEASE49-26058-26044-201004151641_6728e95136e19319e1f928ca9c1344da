package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2083:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1528:ILogger;
      ...
      private var var_429:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1050)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_176);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1295:
            case DisconnectReasonEvent.const_1196:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1244:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1383:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2084)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_720 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_720);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_157);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      {
         var_1050 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_223);
         param1.send(new VersionCheckMessageComposer(401,var_1280,var_2082));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1419,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_429.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_429.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2083);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1419,"/");
      ...
      {
         var_720 = _habboConfiguration.getKey("sso.ticket",null);
         var_1280 = _habboConfiguration.getKey("flash.client.url","");
         var_2082 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_171 == null)
         {
         ...
         if(var_720 != null)
         {
            var_64.mode = HabboConnectionType.const_463;
            var_64.initConnection(HabboConnectionType.const_245);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1528 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_586);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2083 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_463:
               _loc6_ = "";
               ...
               var_1051 = _loc4_;
               var_171.loadBannerImage(_loc7_ + "?token=" + var_1051,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1014:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1297:
               var_607 = generateRandomHexString(30);
               var_429 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_429.init(var_607);
               _loc8_ = var_429.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1051);
         ...
         var_429 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_429.init(_loc14_);
            _loc15_ = var_429.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_1014;
            }
         }
         var_64.initConnection(HabboConnectionType.const_245);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_217);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_175,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_106,onRoomSessionEnded);
      }
