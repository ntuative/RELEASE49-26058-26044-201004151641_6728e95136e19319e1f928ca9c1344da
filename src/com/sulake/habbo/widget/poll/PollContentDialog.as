package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_762[var_1097] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_320)
         {
            ...
            var_320 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_320.center();
            var_320.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1097;
         if(var_1097 < var_762.length)
         {
            _loc1_ = var_762[var_1097] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_762.length);
                  _loc2_.text = _loc6_;
               }
