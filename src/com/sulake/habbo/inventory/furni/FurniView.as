package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_703:MarketplaceModel;
      
      private var var_532:Map;
      
      private var var_533:String;
      
      private const const_1662:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_532 = new Map();
         var_532.add(FurniModel.const_44,new FurniGridView(_model,FurniModel.const_44,_windowManager,_assetLibrary,_roomEngine));
         var_532.add(FurniModel.const_45,new FurniGridView(_model,FurniModel.const_45,_windowManager,_assetLibrary,_roomEngine));
         ...
         switchCategory(FurniModel.const_44);
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_61)
         {
            switch(param2.name)
            {
               case "tab_floor":
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_298);
            }
         }
      }
      ...
      {
         var _loc3_:GroupItem = _model.method_1(_model.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_532.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_532.getValue(var_533);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_44,FurniModel.const_45];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = var_532.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.method_1(_loc3_,var_533);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_302)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_318)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_174)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_703 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_532.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
