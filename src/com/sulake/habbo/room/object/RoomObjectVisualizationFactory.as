package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_799:IAvatarRenderManager = null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_469 != null)
         {
            ...
            {
               _loc1_ = var_469.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_799 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            case RoomObjectVisualizationEnum.const_173:
            ...
            case RoomObjectVisualizationEnum.const_929:
               ...
               break;
            case RoomObjectVisualizationEnum.const_120:
            ...
            case RoomObjectVisualizationEnum.PET:
               ...
               break;
            case RoomObjectVisualizationEnum.const_887:
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_469.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_799;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_799;
            }
            if(var_1750)
            {
               var_469.add(param1,_loc6_);
            }
            return _loc6_;
         }
         return null;
