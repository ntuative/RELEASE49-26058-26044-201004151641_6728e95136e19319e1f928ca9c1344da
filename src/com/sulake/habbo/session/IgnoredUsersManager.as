package com.sulake.habbo.session
{
   ...
   public class IgnoredUsersManager
   {
      ...
      private var var_36:SessionDataManager;
      ...
      {
         var_1375.push(param1);
         var _loc2_:IConnection = var_36.communication.getHabboMainConnection(null);
         _loc2_.send(new IgnoreUserMessageComposer(param1));
      }
      
      public function initIgnoreList() : void
      {
         var _loc1_:IConnection = var_36.communication.getHabboMainConnection(null);
         _loc1_.send(new GetIgnoredUsersMessageComposer(var_36.userName));
      }
      ...
      private function onIgnoreResult(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = String(var_1375.shift());
