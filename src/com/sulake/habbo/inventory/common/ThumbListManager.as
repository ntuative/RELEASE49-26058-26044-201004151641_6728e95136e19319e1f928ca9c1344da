package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_572 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_572.width;
         var_91 = var_572.height;
         var_993 = param5;
         var_810 = param6;
         var_219 = Math.floor(var_993 / _thumbWidth);
         var_17 = new BitmapData(var_993,var_810);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_17.height < var_810)
         {
            _loc12_ = new BitmapData(var_17.width,var_810);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_572.width,var_572.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_572.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_572,var_572.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_479 = resolveRowCountFromList();
         if(var_479 == 0)
         {
            var_17 = new BitmapData(var_993,var_810);
            return;
         }
         var_17 = new BitmapData(Math.max(var_219 * _thumbWidth,var_993),Math.max(var_479 * var_91,var_810),true,16777215);
         var_17.fillRect(var_17.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_479)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_219 && var_17.height < _loc3_.y * var_91)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_219 - 1),var_91);
         _loc2_.copyPixels(var_17,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_219 - 1),0,_thumbWidth,var_17.height);
         _loc2_.copyPixels(var_17,_loc4_,new Point(0,var_91),null,null,true);
         _loc4_ = new Rectangle(0,var_91,_thumbWidth * (var_219 - 1),0 - var_91);
