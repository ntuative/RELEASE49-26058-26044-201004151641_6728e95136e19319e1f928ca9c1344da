package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_357.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_357)
         {
            var_357.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_357.reset();
            var_357 = null;
         }
         if(var_308)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_49 == null)
         {
            var_49 = IWindowContainer(_navigator.getXmlWindow(var_1181));
            var_49.visible = false;
         ...
         var_49.x = _loc2_.x + var_1945 + param1.width;
      ...
      private function refreshPopupArrow(param1:IWindowContainer, param2:Boolean, param3:Boolean) : void
      {
         ...
         else
         {
            if(_loc5_ == null)
            {
               ...
               _loc5_.setParamFlag(HabboWindowParam.const_73,false);
