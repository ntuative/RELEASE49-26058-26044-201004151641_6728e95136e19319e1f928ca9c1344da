package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1427:uint = 4.294967295E9;
      
      private const const_1426:uint = 4.293848814E9;
      
      private var var_851:int;
      
      private const const_1648:uint = 4.291613146E9;
      
      private var var_263:int = -1;
      ...
      private const const_1649:int = 10;
      ...
      private var var_76:IPurchasableOffer;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_612:
               showSelectors(false);
               break;
            case WindowEvent.const_568:
               showSelectors(true);
         }
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_850;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_850,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1426) : uint(const_1427);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1400;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_84);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_399,var_76,var_1022);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_263) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_850);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_595[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_596[var_193]);
         _catalog.purchaseProductAsGift(var_399,var_76,var_1022,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_53:
               ...
               break;
            case WindowKeyboardEvent.const_635:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_263 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_263 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1400 = _loc1_.stuffTypes;
            var_595 = _loc1_.boxTypes;
            var_596 = _loc1_.ribbonTypes;
            var_850 = var_1400[0];
            _boxIndex = var_595[0];
            var_193 = var_596[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_263) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_263);
         }
         var_263 = param1;
         if(var_263 < 0)
         {
            var_263 = _loc2_.numListItems - 1;
         }
         if(var_263 >= _loc2_.numListItems)
         {
            var_263 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_263) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_507 == null)
         {
            var_507 = createWindow("suggestion_list_item") as IWindowContainer;
            var_507.procedure = suggestionsEventHandler;
         }
         if(var_227 == null || var_507 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_227.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_507.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
