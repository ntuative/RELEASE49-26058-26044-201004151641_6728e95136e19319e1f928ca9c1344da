package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         var_728 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_727 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_130 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_728.hasItem(param1))
         {
            var_728.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_727.hasItem(param1))
         {
            var_727.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
