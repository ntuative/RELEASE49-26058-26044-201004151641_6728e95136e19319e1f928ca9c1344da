package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private var var_222:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_438,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_472,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_403,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_438,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_472,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_403,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_438:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_472:
               if(!var_222)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_403:
               if(!var_222)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_661,var_149);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_41,0 | 0,new Rectangle(const_1049,const_1050,2,2),null,0) as IWindowContainer;
