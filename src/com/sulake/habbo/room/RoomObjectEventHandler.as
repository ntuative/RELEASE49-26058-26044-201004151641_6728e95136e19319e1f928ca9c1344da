package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_285);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_628);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_932);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_602);
         }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_363:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1189));
               break;
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_905));
         }
      }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_33 || _loc5_ == RoomObjectCategoryEnum.const_38)
               {
                  _loc8_ = _loc12_.x;
                  _loc9_ = _loc12_.y;
               }
               else if(_loc5_ == RoomObjectCategoryEnum.const_31)
               {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_38 && _loc3_.typeId == RoomObjectTypeEnum.const_335)
               {
         ...
         {
            _roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_224,param1,param2,_loc4_,_loc5_));
         }
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_31:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_650,param1,param2,param3,param4));
         }
      }
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_230,param2);
         }
      }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_31 && _loc9_ != null)
            {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_33)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_602);
         ...
         if(_loc6_ != null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_31)
            {
               _loc12_ = false;
               if(_loc9_ != null)
               {
      ...
      private function changeObjectState(param1:int, param2:int, param3:int, param4:String, param5:int, param6:Boolean) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            else if(_loc7_ == RoomObjectCategoryEnum.const_31)
            {
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = getMouseEventId(RoomObjectCategoryEnum.const_211,MouseEvent.CLICK);
         switch(_loc4_)
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc8_ == RoomObjectCategoryEnum.const_65)
               {
                  if(_loc5_ != null)
                  {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc8_ == RoomObjectCategoryEnum.const_38)
                  {
                     if(_loc10_ != null)
                     {
                        setMouseEventId(RoomObjectCategoryEnum.const_65,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_65)
         {
            _loc12_ = getMouseEventId(RoomObjectCategoryEnum.const_65,MouseEvent.CLICK);
            if(_loc12_ != _loc10_)
            {
               _loc13_ = _roomEngine.events;
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_367,param2,param3,-1,RoomObjectCategoryEnum.const_211));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
      ...
      private function useObject(param1:int, param2:int, param3:int, param4:String, param5:String) : void
      {
         if(_roomEngine != null && false)
         {
            switch(param5)
            {
               case RoomObjectFurnitureActionEvent.const_484:
      ...
      private function handleRoomObjectMouseDown(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_33 || _loc8_ == RoomObjectCategoryEnum.const_31)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_505,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_285);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_385);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
         ...
         switch(param5)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_MOVE_TO:
               ...
               if(false)
               {
                  ...
                  else if(param4 == RoomObjectCategoryEnum.const_31)
                  {
                     _loc9_ = int(_loc6_.getDirection().x) % 360;
                     ...
                     if(false && _loc11_)
                     {
                        ...
                        {
                           _roomEngine.connection.send(new PickupObjectMessageComposer(param3,param4));
                           _roomEngine.connection.send(new PlaceObjectMessageComposer(param3,RoomObjectCategoryEnum.const_31,_loc12_,0,0,0));
                        }
                     }
                  }
               }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_270:
               _roomEngine.events.dispatchEvent(param1);
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_483:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_326:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_297:
               _loc7_ = "null";
         }
         if(_loc7_ == null)
         {
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_205:
               handleRoomObjectMouseClick(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_375:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = _roomEngine.getRoomObject(roomId,roomCategory,var_973,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            if(wasSelected)
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_479));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_359));
            }
         }
      }
      ...
      private function handleRoomActionEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_408:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_465:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_285);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_385);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      {
         var _loc3_:Map = var_563.getValue(String(param1)) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:Map = var_563.getValue(String(param1)) as Map;
         if(_loc4_ == null)
         {
            _loc4_ = new Map();
            var_563.add(param1,_loc4_);
         }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc8_.getEventHandler().processUpdateMessage(_loc10_);
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_479);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_359);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
         ...
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc7_ == RoomObjectCategoryEnum.const_65)
               {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_255:
               handleObjectStateChange(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_592:
            ...
            case RoomObjectMoveEvent.const_425:
               ...
               break;
            case RoomObjectMoveEvent.const_419:
            ...
            case RoomObjectRoomAdEvent.const_297:
               ...
               break;
            case RoomObjectRoomActionEvent.const_408:
            case RoomObjectRoomActionEvent.const_802:
            case RoomObjectRoomActionEvent.const_465:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_429:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_823));
               break;
            case RoomObjectFurnitureActionEvent.const_405:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1264));
               break;
            case RoomObjectFurnitureActionEvent.const_401:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_905));
         }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:String, param4:IRoomGeometry) : void
      {
         ...
         var _loc6_:int = _roomEngine.getRoomObjectCategory(_loc5_);
         if(_loc6_ != RoomObjectCategoryEnum.const_65)
         {
            _loc6_ = 0;
         }
