package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1421:int = 5;
      
      private static const const_499:int = 16;
      
      private static const const_1074:int = 20;
      
      private static const const_352:int = 10;
      
      private static const const_1075:int = 40;
      ...
      private var var_390:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1020 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1973 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1971 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_700 = new Timer(1000,1);
         var_700.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_845 = new Timer(5000,1);
         var_845.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_59,HabboWindowStyle.const_42,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_143,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_46,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_132,onInputChanged);
         _window.addEventListener(WindowEvent.const_456,onWindowMoved);
         var_1232 = true;
         var_127 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1972 = _loc2_.width + const_499 + _loc6_.width + const_1074;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1075,_loc8_.width) + const_499);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1020 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_127 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_390);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_390);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_505);
