package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1119:String = "content";
      
      private static const const_1120:String = "selector";
      ...
      protected var var_1612:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1612 == null)
         {
            var_1612 = findChildByTag(TabContextController.const_1119) as IWindowContainer;
         }
         return var_1612;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_953 == null)
         {
            var_953 = findChildByTag(TabContextController.const_1120) as ITabSelectorWindow;
            if(var_953 != null)
            {
               var_953.procedure = selectorEventProc;
            }
         }
         return var_953;
      }
      ...
      {
         return !!var_840 ? selector.iterator : null;
      }
