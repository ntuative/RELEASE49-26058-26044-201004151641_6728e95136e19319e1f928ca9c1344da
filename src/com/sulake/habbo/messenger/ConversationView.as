package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1036:int = 20;
      
      private static const const_744:int = 100;
       
      
      private var var_1658:IScrollbarWindow;
      
      private var var_137:HabboMessenger;
      
      private var var_1411:IContainerButtonWindow;
      
      private var var_458:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_137 = param1;
         var_1411 = initButton("follow_friend",onFollowButtonClick,param2);
         var_48 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1658 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_581 || param3.type == Message.const_670 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_458.messages.length - const_744);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_458.messages.length)
         {
            refreshEntry(true,_loc1_,var_458.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_458 == null || _loc1_.id != var_458.id)
         {
            var_458 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_744 + const_1036)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_137.send(new FollowFriendMessageComposer(var_458.id));
      }
      ...
      {
         if(param1 == Message.const_581)
         {
            return 4294967295;
         }
         if(param1 == Message.const_670)
         {
            return 4292801535;
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1035;
         param1.invalidate();
      }
   }
}
