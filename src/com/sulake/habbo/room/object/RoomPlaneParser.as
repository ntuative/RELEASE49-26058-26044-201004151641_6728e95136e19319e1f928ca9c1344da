package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_892;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_150,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_277,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_932);
         addPlane(RoomPlaneData.const_150,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_150,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_116) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_150,Vector3d.sum(param1,Vector3d.product(param3,-var_116 / param3.length)),Vector3d.product(param3,(param3.length + var_116) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_932 / param2.length);
               addPlane(RoomPlaneData.const_150,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_722 = getFloorHeight(var_102);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_367 || param1 == var_368)
               {
                  _loc5_ = false;
                  _loc6_ = var_370;
                  while(_loc6_ < var_369)
                  {
               ...
               if(param2 == var_370 || param2 == var_369)
               {
                  _loc7_ = false;
                  _loc8_ = var_367;
                  while(_loc8_ < var_368)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_149,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_116),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,var_116,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,var_116,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_116),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,var_116,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,var_116,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_116),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,var_116,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,var_116,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_116),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,var_116,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,var_116,param11);
                  }
               }
            }
         }
