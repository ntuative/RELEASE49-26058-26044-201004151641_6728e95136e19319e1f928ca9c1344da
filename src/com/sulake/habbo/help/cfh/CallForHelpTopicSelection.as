package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1129:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_750 == null || _loc3_ < 0 || _loc3_ >= var_750.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_750[_loc3_];
            main.showUI(HabboHelpViewEnum.const_526);
            main.tellUI(HabboHelpViewEnum.const_526,null);
         }
      }
   }
}
