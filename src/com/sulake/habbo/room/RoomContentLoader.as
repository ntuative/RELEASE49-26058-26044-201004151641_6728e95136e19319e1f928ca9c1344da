package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_760:String = "selection_arrow";
      
      private static const const_761:String = "tile_cursor";
      
      private static const const_278:String = "RCL_PUBLICROOM_";
      
      private static const const_489:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_347:String = "place_holder";
      
      private static const const_1059:String = const_347;
      ...
      public static const const_651:String = "RCL_LOADER_READY";
      ...
      private var var_992:IEventDispatcher = null;
      
      private var var_1195:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_476 = [];
         var_477 = [];
         var_1811 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1812 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_404 = new Map();
         _events = new Map();
      ...
      {
         if(var_164 != null && var_164.hasWorldType(const_278 + param1))
         {
            return var_164.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_404 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_404.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_404.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_570.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_404.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_347,const_489,ROOM_CONTENT,const_761,const_760];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1811.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_173 && _loc5_ != RoomObjectLogicEnum.const_120)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_478.getValue(param1) as String;
      ...
      {
         if(var_571.getValue(param1) != null)
         {
            return var_571.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1345);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_440,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_164 != null && (var_164.type == param1 || var_164.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_65;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_65;
      ...
      private function continueInitilization() : void
      {
         if(var_1813)
         {
            ...
            if(var_992 != null)
            {
               var_992.dispatchEvent(new Event(const_651));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_164 != null)
         {
            return var_164.getWorldHeightScale(const_278 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_992 = param1;
            var_1809 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1810 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1808 = param2.getKey("public.room.dynamic.download.url","");
            var_1814 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_32 = const_759;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_173 && _loc5_ != RoomObjectVisualizationEnum.const_120)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_428.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_278 + param1) == RoomObjectCategoryEnum.const_65)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1195.getValue(param1) != null)
         {
            var_164 = var_1195.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_447,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_164 != null)
         {
            return var_164.getWorldScale(const_278 + param1);
         }
         return 32;
      }
