package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1633:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private const const_1632:int = 13421772;
      
      private var var_435:Rectangle;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_374 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               var_1547 = Math.max(var_1547,_loc6_.colorLayerIndex);
            }
         }
            ...
            if(var_613)
            {
               switch(var_613.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_60:
                     _loc2_.style = HabboIconType.const_654;
                     break;
                  case HabboClubLevelEnum.const_51:
                     _loc2_.style = HabboIconType.const_582;
               }
            }
            else
            {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_971 + "_" + FigureData.const_252;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_435.width,var_435.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_971 + "_" + FigureData.const_252;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1548 && _loc2_.colorLayerIndex > 0)
               {
