package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      private function renderRepeatLast(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_28,_loc3_,true,param1);
         _loc2_ = var_28["-1"] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         while(_loc9_ < 0)
         {
            _loc2_ = var_28[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         if(_loc10_ == 0)
         {
            _loc2_ = var_28[0] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
               _loc8_ = _loc2_.getHeight(param1);
               if(_loc8_ > 0)
      ...
      private function renderRepeatAll(param1:IVector3d) : void
      {
         ...
         var _loc2_:int = getCellsHeight(var_28,param1);
         var _loc3_:int = 0;
      ...
      {
         var _loc3_:int = 0;
         if(_repeatMode == const_525)
         {
            _loc3_ = getCellsHeight(var_28,param2);
            param1 = _loc3_;
         }
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.height == param1 && Vector3d.isEqual(var_589,param2))
               {
                  return var_23;
               }
               var_23.dispose();
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_28.length)
            {
               _loc2_ = var_28[_loc1_] as PlaneMaterialCell;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_28,_loc3_,false,param1);
         _loc2_ = var_28[0] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatNone(param1:IVector3d) : void
      {
         ...
         renderCells(var_28,0,true,param1);
      }
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         while(_loc7_ < -1)
         {
            _loc2_ = var_28[_loc7_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
