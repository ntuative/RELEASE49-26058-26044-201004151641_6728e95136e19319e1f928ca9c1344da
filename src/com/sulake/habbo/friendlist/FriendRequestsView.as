package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1434:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_300 && _loc4_.state != FriendRequest.const_323)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_300;
      ...
      {
         var_1574 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1575 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1575.procedure = onDismissAllButtonClick;
         var_1574.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_300 && _loc4_.state != FriendRequest.const_323)
            {
               _loc4_.state = FriendRequest.const_323;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_271,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_88,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_146)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1574,_loc1_);
         setEnabled(var_1575,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_300;
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         var_48.removeListItem(param1.view);
         refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         var_48.addListItem(param1.view);
         _friendList.friendRequests.refreshShading();
         refreshButtons();
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_323;
         var _loc3_:DeclineBuddyMessageComposer = new DeclineBuddyMessageComposer();
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_271,param1));
         }
      }
   }
}
