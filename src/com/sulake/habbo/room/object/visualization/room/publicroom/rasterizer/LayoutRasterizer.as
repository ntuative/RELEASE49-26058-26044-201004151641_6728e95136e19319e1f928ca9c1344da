package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1033:Point = null;
      
      private var var_513:Array;
      
      private var var_1032:LayoutRasterizerData = null;
      ...
      private var var_511:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_833:IGraphicAssetCollection;
      ...
      {
         var_511 = true;
         var _loc3_:int = var_354.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_354.push(param1);
            var_512.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1031 = param1;
         var _loc3_:LayoutRasterizerData = var_38.getValue(var_705);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1252 = RoomObjectVariableEnum.const_893;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1252 = RoomObjectVariableEnum.const_838;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1031 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1031 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1031 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1031 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1252);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_462;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2005);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_38.length)
            {
               _loc2_ = var_38.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_705)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1032 = var_38.getValue(var_705);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_38.getValue(var_705);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1032.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_833.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1033.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1033.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_354.indexOf(_loc10_) >= 0 && var_511)
            {
               param1 = var_354.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_833.getAsset(var_512[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_513[param1];
               }
               var_354.splice(param1,1);
               var_512.splice(param1,1);
               var_513.splice(param1,1);
               if(false)
               {
                  var_511 = false;
               }
