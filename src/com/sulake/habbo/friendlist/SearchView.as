package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_659:ITextFieldWindow;
      ...
      {
         var_659 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_659.procedure = onSearchInput;
         var_659.addEventListener(WindowKeyboardEvent.const_143,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_332.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_332.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_48.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_309,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = var_48.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_659.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(var_48.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
