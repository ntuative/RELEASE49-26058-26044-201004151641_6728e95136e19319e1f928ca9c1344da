package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_499:int = 6;
      
      private static const const_352:int = 10;
      
      private static const const_1118:Number = 18;
      
      private static const const_1432:Number = 10;
      
      private static const const_1433:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1083,var_1084,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1083,var_746,var_1084,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1329 = param1.chatType;
         var_1083 = param1.userId;
         var_746 = param1.userName;
         var_1084 = param1.userCategory;
         _message = param1.text;
         var_1330 = param1.userX;
         var_201 = param1.userImage;
         var_1085 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_32,onBubbleMouseOut);
            param1.addEventListener(WindowMouseEvent.const_100,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1329)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_103:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_276:
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1085 != 0)
            {
               _loc30_ = uint(var_1085 >> 16 & 255);
               _loc31_ = uint(var_1085 >> 8 & 255);
               _loc32_ = uint(var_1085 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_352;
            }
            else
            {
               _loc19_.text = var_746 + ":";
               _loc19_.y += var_443;
               _loc19_.width = _loc19_.textWidth + const_352;
               _width += _loc19_.textWidth + const_352;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1329 == RoomWidgetChatUpdateEvent.const_276)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_746);
            }
            else if(var_1329 == RoomWidgetChatUpdateEvent.const_268)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_746);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_443;
            _loc20_.width = _loc20_.textWidth + const_499;
            _width += _loc20_.textWidth + const_499;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_352 + _loc20_.textWidth + const_499;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1083,var_1084,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1083,var_1084,_roomId,_roomCategory,param1);
      }
