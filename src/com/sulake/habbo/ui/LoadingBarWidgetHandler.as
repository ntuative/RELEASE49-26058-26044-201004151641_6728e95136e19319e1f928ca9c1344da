package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_469);
         _loc1_.push(AdEvent.const_435);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_96);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_272);
         return _loc1_;
      }
