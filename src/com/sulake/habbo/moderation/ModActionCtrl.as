package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_885:IDropMenuWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_887 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_886 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_885.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1302,var_434.text,getBanLength(),var_1303));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_885.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1302,var_434.text,var_1303));
         this.dispose();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1302,var_434.text,var_1303));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this.refreshButtons("offences_cont",2,var_738.offences,var_887,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_886,onOffenceCtgButton);
      ...
      public function show() : void
      {
         ...
         var_52.caption = "Mod action on: " + var_1487;
         ...
         var_885 = IDropMenuWindow(var_52.findChildByName("banLengthSelect"));
         prepareBanSelect(var_885);
