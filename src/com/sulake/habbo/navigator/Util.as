package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1544:CutToHeight = new CutToHeight();
      
      private static var var_1545:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1544.beforeSearch(param2,param1,param3);
         binarySearch(var_1544,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1545.beforeSearch(param2,param1,param3);
         binarySearch(var_1545,param2.length - 1);
      }
   }
}
