package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         return var_392 == int.MIN_VALUE && var_390 == int.MAX_VALUE && var_393 == int.MIN_VALUE && var_391 == int.MAX_VALUE;
      }
      ...
      {
         var_391 = param1;
         if(var_391 < int.MAX_VALUE && true && _target.height > var_391)
         {
            _target.height = var_391;
         }
      }
