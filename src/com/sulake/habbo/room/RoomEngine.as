package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_495:String = "room";
      
      private static const const_778:int = -2;
      
      private static const const_494:String = "temporary_room";
      
      private static const const_279:String = "object_icon_sprite";
      
      private static const const_779:int = -3;
      
      private static const const_777:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1095:String = "tile_cursor";
      
      private static const const_280:int = -1;
       
      
      private var var_428:IRoomObjectVisualizationFactory = null;
      ...
      private var var_603:NumberBank;
      ...
      private var var_716:RoomMessageHandler = null;
      
      private var var_717:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_307 = new Map();
         var_603 = new NumberBank(1000);
         var_1043 = new Map();
         var_306 = new Map();
         var_63 = new RoomObjectEventHandler(this);
         var_716 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_63 != null)
         {
            ...
            {
               return var_63.deleteWallItem(var_111,var_112,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_307.length; _loc2_++)
         {
            _loc3_ = var_307.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_678) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_623) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_599) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_684) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(param3 == RoomObjectCategoryEnum.const_31)
         {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_31)
            {
               return var_63.modifyWallItemData(var_111,var_112,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_428 != null)
         {
            var_428.release(new IIDRoomObjectVisualizationFactory());
            var_428 = null;
         }
         if(var_40 != null)
         {
         ...
         if(var_717 != null)
         {
            var_717.release(new IIDRoomRendererFactory());
            var_717 = null;
         }
         ...
         if(var_265)
         {
            var_265.release(new IIDHabboAdManager());
            var_265 = null;
         }
         _connection = null;
         if(var_603 != null)
         ...
         if(var_307 != null)
         {
            ...
            {
               _loc2_ = var_307.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_717.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_798;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_685);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_572);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_564);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1023);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_912);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_848) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_961);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_360,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_521,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_725,var_111,var_112,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            return var_63.modifyRoomObject(var_111,var_112,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_306.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_306.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_707,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_693,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_567,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_40 != null)
         {
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_33);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_31);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_38);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_65);
            var_40.setContentLoader(var_11);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_63 != null)
         {
            var_63.handleRoomObjectEvent(param1,var_111,var_112);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_218,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_293,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_288,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_901,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1021,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_819,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_242,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         var _loc15_:ISelectedRoomObjectData = getPlacedObjectData(param1,param2);
         if(_loc15_ && Math.abs(_loc15_.id) == param3 && _loc15_.category == RoomObjectCategoryEnum.const_33)
         {
            selectRoomObject(param1,param2,param3,RoomObjectCategoryEnum.const_33);
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_554,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_26 == null || var_428 == null || var_40 == null || var_717 == null || _communication == null || _habboConfiguration == null || !var_2057)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_280,RoomObjectCategoryEnum.const_65);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         if(_loc12_ && Math.abs(_loc12_.id) == param3 && _loc12_.category == RoomObjectCategoryEnum.const_33)
         {
            selectRoomObject(param1,param2,param3,RoomObjectCategoryEnum.const_33);
         }
         return true;
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1299,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_40.getRoom(getRoomIdentifier(var_111,var_112));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_779,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1272);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1272);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_428 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_428;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_205,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_375,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_255,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_592,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_135,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_130,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_118,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_108,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_97,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_484,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_392,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_380,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_453,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_429,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_405,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_401,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_363,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_67,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_425,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_419,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_270,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_483,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_326,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_297,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_408,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_802,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_465,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_464,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_211;
      }
      
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         var _loc5_:IRoomInstance = getRoom(var_111,var_112);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_529) != 0)
         {
            return false;
         }
         if(var_63 != null)
         {
            return var_63.initializeRoomObjectInsert(var_111,var_112,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_517 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_727,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_306.length)
            {
               _loc3_ = var_306.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_242,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_31:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_218));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_376);
                     break;
                  case RoomObjectCategoryEnum.const_38:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_154);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_328);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_651)
         {
            var_2057 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_218,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_293,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_288,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_798,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_242,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
         var _loc13_:ISelectedRoomObjectData = getPlacedObjectData(param1,param2);
         if(_loc13_ && _loc13_.id == param3 && _loc13_.category == RoomObjectCategoryEnum.const_31)
         {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_265 = param2 as IAdManager;
         var_265.events.addEventListener(AdEvent.const_355,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_777) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_307.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_617,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_717 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_40.getRoom(const_494);
         if(_loc10_ == null)
         {
            _loc10_ = var_40.createRoom(const_494,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_603.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_33:
            case RoomObjectCategoryEnum.const_31:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_218,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_376,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_154,param2);
               break;
            case RoomObjectCategoryEnum.const_65:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_149,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_712,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_519,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_619,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_360,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1043.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_880,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_603.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_778,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,param1);
         if(_loc9_ != null)
         {
            var_1272 = param1;
            var_1520 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1520 - _loc12_.width / 2;
               _loc11_.y = var_1521 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_367,var_111,var_112,-1,RoomObjectCategoryEnum.const_211));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_63 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_280,const_495);
                  var_63.handleRoomObjectEvent(_loc14_,var_111,var_112);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_111,var_112,param1,param2,new Vector3d(),1,null);
         }
         else if(var_11 != null)
         {
            _loc8_ = null;
            ...
            else if(param2 == RoomObjectCategoryEnum.const_31)
            {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1272);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1520 - _loc6_.data.width / 2;
               _loc11_.y = var_1521 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_290,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_893,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_838,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_879,RoomObjectVariableEnum.const_290,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_307.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_307.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_651,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_63 != null)
         {
            var_63.cancelRoomObjectInsert(var_111,var_112);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_40.getRoom(const_494);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_880);
               ...
               var_603.freeNumber(_loc10_ - 1);
               _loc13_ = var_1043.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_111,var_112,const_280,RoomObjectCategoryEnum.const_65,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_877,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_529,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_817,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_280,const_495,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_529,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_685,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_678,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_599,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_623,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_684,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_884,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_707,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_693,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_567,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_360,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_206);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_572,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_564,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_572,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_564,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1023,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_912,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_778,const_1095,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_779,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
