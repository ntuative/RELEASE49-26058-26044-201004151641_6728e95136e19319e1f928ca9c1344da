   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            _loc6_ = _container.avatarRenderManager.createAvatarImage(_loc4_,AvatarScaleType.const_55,_loc5_);
            if(_loc6_ != null)
            {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_187 + " " + _loc7_);
            if(var_187 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_914,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_187.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_514,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               ...
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_102,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_514,onFigureUpdate);
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_936,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_965,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            ...
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_102,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_102:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_102));
               break;
      ...
      private function onHabboClubSubscriptionChanged(param1:Event = null) : void
      {
         ...
         if(var_10 != null)
         {
            ...
            _container.events.dispatchEvent(new RoomWidgetHabboClubUpdateEvent(var_10.clubDays,var_10.clubPeriods,var_10.clubPastPeriods,_loc2_,var_10.clubLevel));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_644);
         _loc1_.push(RoomWidgetDanceMessage.const_723);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_645);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_676);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_664);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_636);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_595);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_545);
         _loc1_.push(RoomWidgetStopEffectMessage.const_561);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1145);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_868);
         _loc1_.push(RoomWidgetToolbarMessage.const_573);
         _loc1_.push(RoomWidgetToolbarMessage.const_600);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_667);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1209);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_993);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_734);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_686);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_601);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1304);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_534);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_580);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_630);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_729));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetGetEffectsMessage.const_645:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_676:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_664:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_545:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_889)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_202,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_595:
               ...
               if(var_10 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_804:
                        _catalog.openCatalogPage(CatalogPageName.const_1210,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_845:
                        var_10.toggleInventoryPage(InventoryCategory.const_256);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1346:
                        var_10.toggleInventoryPage(InventoryCategory.const_75);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1236:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_636:
            case RoomWidgetStopEffectMessage.const_561:
            ...
            case RoomWidgetNavigateToRoomMessage.const_868:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_734:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_573:
               ...
               if(var_187)
               {
                  var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
                     ...
                     _container.events.dispatchEvent(new RoomWidgetHabboClubUpdateEvent(var_10.clubDays,var_10.clubPeriods,var_10.clubPastPeriods,_loc12_,var_10.clubLevel));
                  }
               ...
               break;
            case RoomWidgetToolbarMessage.const_600:
               ...
               if(var_187 && false)
               {
                  var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_415,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_667:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_412));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_601:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_296,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_534:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_296,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_580:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_296,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_630:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_445));
               }
               break;
            default:
