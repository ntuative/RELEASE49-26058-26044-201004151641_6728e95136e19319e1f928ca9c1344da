package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2383:Dictionary;
      ...
      private var var_834:RoomCreateViewCtrl;
      
      private var var_1910:RoomThumbnailRenderer;
      
      private var var_187:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_588:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_407:Tabs;
      
      private var var_258:MainViewCtrl;
      
      private var var_1909:Array;
      
      private var var_979:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_258 = new MainViewCtrl(this);
         var_588 = new RoomInfoViewCtrl(this);
         var_834 = new RoomCreateViewCtrl(this);
         var_1910 = new RoomThumbnailRenderer(this);
         var_979 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_407 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_258.startSearch(Tabs.const_198,Tabs.const_337,param1);
         var_258.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(_windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function showOwnRooms() : void
      {
         ...
         var_258.startSearch(Tabs.const_247,Tabs.const_226);
         var_407.getTab(Tabs.const_247).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_258.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
