package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_493:String = "tab_girl";
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_492:
                  _model.controller.gender = FigureData.const_79;
                  param1.stopPropagation();
                  break;
               case const_493:
                  _model.controller.gender = FigureData.const_87;
                  param1.stopPropagation();
            }
         }
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(_model.controller.gender)
         {
            case FigureData.const_79:
               ...
               inactivateTab(const_493);
               break;
            case FigureData.const_87:
               activateTab(const_493);
