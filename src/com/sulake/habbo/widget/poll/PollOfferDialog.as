package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_251:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_549:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1355:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_32 = const_1355;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_662,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_32 = const_549;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_471,_id));
