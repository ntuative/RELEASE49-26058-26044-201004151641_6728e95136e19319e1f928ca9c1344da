package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_537 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         return !true ? var_138[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_641))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_641,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_92 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_641,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_537.parse(param1))
         {
            ...
            if(false)
            {
               var_138["null"] = var_537;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1233,var_537));
            var_537 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_138 != null && param1 < var_46.length)
         {
            _loc2_ = var_46[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_46.splice(param1,1);
               delete var_138[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
