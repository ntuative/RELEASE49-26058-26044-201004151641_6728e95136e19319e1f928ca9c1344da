package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_786:String = "margin_top";
      
      private static const const_1111:String = "_HEADER";
      
      private static const const_785:String = "margin_right";
      
      private static const const_1112:String = "_SCALER";
      
      private static const const_1066:String = "_TITLE";
      
      private static const const_1113:String = "_CONTENT";
      
      private static const const_784:String = "margin_left";
      
      private static const const_783:String = "margin_bottom";
      ...
      private var var_1309:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_784,_loc3_.left,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_786,_loc3_.top,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_785,0 - _loc3_.right,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_783,0 - _loc3_.bottom,PropertyStruct.const_63,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_221);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_199);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_221,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_221,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1309 == null)
         {
            var_1309 = findChildByTag(const_1111) as IHeaderWindow;
            if(!var_1309)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1066) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1112) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_240,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1113) as IWindowContainer;
            if(!var_19)
            {
