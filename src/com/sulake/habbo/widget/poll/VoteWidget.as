package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_757:Array = null;
      ...
      private var var_1337:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1337 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_123,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_114,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_292,update);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            var_48.addListItem(_loc6_);
            _loc7_++;
         }
         var _loc8_:int = Math.max(var_48.scrollableRegion.height - 0,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         var_48 = _window.findChildByName("choices") as IItemListWindow;
         if(var_48 == null)
         {
            return false;
         }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_2055;
         if(_loc2_ > var_1337)
         {
            vote();
            return;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(var_48.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_48.numListItems)
         {
            _loc4_ = var_48.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_48.numListItems)
         {
            _loc2_ = var_48.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_123,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_114,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_292,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1337 - param1) / 1000,0);
