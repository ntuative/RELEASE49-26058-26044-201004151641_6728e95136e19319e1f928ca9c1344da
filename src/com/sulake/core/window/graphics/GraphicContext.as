package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected static var var_644:uint = 0;
      
      protected static var var_380:uint = 0;
      
      public static const GC_TYPE_TEXTFIELD:uint = 2;
      
      public static const const_1596:uint = 128;
      
      public static const const_1615:uint = 64;
      ...
      protected var var_639:Boolean;
      
      protected var var_1611:Boolean;
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_639)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_380 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_639)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_380 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1611,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1611,16777215);
                  }
                  var_380 += bitmap.width * bitmap.height * 4;
               }
