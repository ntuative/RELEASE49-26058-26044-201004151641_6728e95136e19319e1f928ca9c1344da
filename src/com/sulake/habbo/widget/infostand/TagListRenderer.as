package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1647:int = 5;
      
      private const const_1646:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1207 != null && var_1207.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_821 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_821 += param1.height + const_1646;
            return fit(param1);
         }
         param1.offset(_offsetX,var_821);
         _offsetX += param1.width + const_1647;
         return true;
      }
