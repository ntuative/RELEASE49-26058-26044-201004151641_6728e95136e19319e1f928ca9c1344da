package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1408:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_555 = new Array();
         var_1409 = new Point();
         var_1408 = new Rectangle();
         var_290 = new Rectangle();
         var_289 = new Dictionary(true);
         var_672 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_289[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_555.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_699,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_289[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_289[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_555 = null;
            for(_loc1_ in var_289)
            {
               delete var_289[_loc1_];
            }
            var_289 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1409,var_1408))
            {
               if(param2.render(param1,var_1409,var_1408))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_672);
            var_289[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_699,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            getWindowRendererItem(param1).invalidate(param1,var_290,WindowRedrawFlag.const_251);
            if(var_555.indexOf(param1) == -1)
            {
               var_555.push(param1);
            }
         }
