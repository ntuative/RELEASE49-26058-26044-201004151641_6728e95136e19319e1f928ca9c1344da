package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1011 + var_1011 / -var_2359 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_839 - var_839 / var_413 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_413).toString().length - 1);
         var_413 = Math.ceil(var_413 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_413.toString();
         _loc3_.draw(_loc6_);
         var_1011 = param1 - _loc6_.textWidth - 2;
         var_839 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_839);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_839 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1011 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1011,(param2 - var_839) / 2));
         return _loc3_;
      }
