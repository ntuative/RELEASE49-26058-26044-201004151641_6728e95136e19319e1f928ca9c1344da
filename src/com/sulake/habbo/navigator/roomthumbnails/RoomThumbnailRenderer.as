package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1100:int = -16;
      
      private static const const_782:int = 32;
      
      private static const const_1101:int = 8;
      
      public static const const_418:int = 10;
      ...
      private var var_1066:Dictionary;
      
      private var var_2111:Dictionary;
      
      private var var_884:ThumbnailImageConfigurations;
      
      private var var_1296:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_1066 = new Dictionary();
         super();
         _navigator = param1;
         var_884 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_42,0 | (!!param3 ? HabboWindowParam.const_43 : HabboWindowParam.const_42),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_884.getImage(ThumbnailEditorModel.const_35,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1100,_loc4_.y + const_1102 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2111[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_884.getImage(ThumbnailEditorModel.const_39,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_884.getImage(ThumbnailEditorModel.const_39,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_884.getImage(ThumbnailEditorModel.const_56,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_782 + _loc3_,param2 * const_1101);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_418)
         {
            var_1066[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1066[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_418)
         {
            if(false)
            {
               refreshObj(param1,var_1066[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1296 == null)
         {
            var_1296 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1296,var_1296.rect,new Point(0,0),null,null,true);
      }
   }
}
