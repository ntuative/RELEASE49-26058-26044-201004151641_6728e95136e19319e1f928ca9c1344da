package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1305 || var_1501 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1502 == 0 || _loc1_ - var_1502 > var_1501)
         {
            if(_connection != null)
            {
      ...
      {
         var_1305 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1501 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
