package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_608,RoomWidgetEcotronBoxOpenMessage.const_543,RoomWidgetEcotronBoxOpenedMessage.const_1153];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_608:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_543:
