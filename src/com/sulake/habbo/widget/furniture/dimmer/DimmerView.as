package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1049:Number = 100;
      
      private static const const_1050:Number = 100;
       
      
      private var var_1154:XML;
      
      private var var_418:int;
      
      private var var_468:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1741:int;
      
      private var var_335:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_236.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_236.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_59,HabboWindowStyle.const_41,0 | 0,new Rectangle(const_1049,const_1050,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_468 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_335 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_236 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_236.numTabItems)
         {
            _loc6_ = var_236.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_468 != null)
         {
            var_468.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_236.selector.getSelected();
         return var_236.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_335 != null)
         {
            var_335.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_974 = _loc2_.light;
         if(var_335 != null)
         {
            var_335.setValue(var_974);
         }
         var_418 = colors.indexOf(_loc2_.color);
         if(var_468 != null)
         {
            var_468.setSelectedColorIndex(var_418);
         }
