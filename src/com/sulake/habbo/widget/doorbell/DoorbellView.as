package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_52 = (_doorbell.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_52 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_48 = var_52.findChildByName("user_list") as IItemListWindow;
         var_52.visible = false;
         var _loc2_:IWindow = var_52.findChildByTag("close");
         if(_loc2_ != null)
         {
      ...
      public function update() : void
      {
         ...
         if(var_48 != null)
         {
            var_48.destroyListItems();
            _loc1_ = 0;
            while(_loc1_ < _doorbell.users.length)
            {
               var_48.addListItem(createListItem(_doorbell.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
