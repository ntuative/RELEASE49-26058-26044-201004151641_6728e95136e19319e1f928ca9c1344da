package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_731:IItemListWindow;
      
      private var _model:WardrobeModel;
      
      private var _window:IWindowContainer;
      
      private var var_1060:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_731 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1060 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_731)
         {
            var_731.removeListItems();
         }
         if(var_1060)
         {
            var_1060.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_731)
               {
                  var_731.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1060)
            {
               var_1060.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
