package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_148 && false)
         {
      ...
      private function method_8(param1:int) : PetData
      {
         var _loc2_:* = null;
         for each(_loc2_ in var_1015)
         {
            if(_loc2_.id == param1)
            {
               return _loc2_;
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1228 && param1.type == RoomEngineObjectEvent.const_224)
         {
            var_47.showView();
            var_1228 = false;
         }
      ...
      {
         var _loc3_:PetData = method_8(param1);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         {
            var_1228 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_38,RoomObjectTypeEnum.const_335,_loc3_.figure);
            var_47.closeView();
            return;
         }
      ...
      {
         if(var_1015.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
