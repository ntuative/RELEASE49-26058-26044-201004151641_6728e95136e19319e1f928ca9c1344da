package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_20:String = "client.init.volter.retry";
      ...
      public static const const_18:String = "client.init.volter.loaded";
      
      private static const const_23:String = "testLocalConnection";
      
      public static const const_11:String = "error_data";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_21] = new Date().getTime().toString();
            _loc7_ = "";
            _loc6_[const_8] = _loc7_;
            _loc6_[const_12] = Capabilities.version;
            _loc6_[const_16] = 0;
            _loc6_[const_15] = param1;
            _loc6_[const_10] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_11] = String(param3.getStackTrace());
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:TextField = param1.getChildByName(const_4) as TextField;
         if(_loc2_)
         {
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_22,error);
         }
      }
      ...
      private function onVolterLoadingCompleted(param1:Event) : void
      {
         ...
         if(var_1)
         {
            updateFont(var_1.getChildByName(const_4) as TextField,"Volter",true);
