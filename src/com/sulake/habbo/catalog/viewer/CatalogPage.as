package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1403:String = "ctlg_";
      ...
      private var var_1348:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_854:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1403 + param1;
         ...
         var_1396 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1396) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1181) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1335) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1270) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1348;
            _loc2_.init();
         }
         var_1348.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1348.dispatchEvent(param1);
      }
