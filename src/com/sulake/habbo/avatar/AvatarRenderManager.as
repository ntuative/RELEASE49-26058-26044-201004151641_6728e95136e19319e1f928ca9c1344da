package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_987:PaletteManager;
      
      private var var_680:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_85:
               _loc3_ = var_218.getValue(AvatarType.const_85) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_218.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_218.getValue(AvatarType.const_85) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_218.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_680 = new PetDataManager(_loc1_,_loc3_);
         var_987 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_680.populateFigureData(_loc4_);
         ...
         var_218.add(AvatarType.const_85,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_218.add(AvatarType.PET,_loc5_);
      }
      
      public function get petDataManager() : IPetDataManager
      {
         return var_680 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_694 = param1;
         if(var_694 == RenderMode.const_1199)
         {
            init();
         }
         if(var_694 == RenderMode.const_1232)
         {
            init();
      ...
      {
         var _loc5_:String = var_680.createAvatarFigureString(param1,param2,param3);
         var _loc6_:AvatarStructure = var_218.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_218.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:AvatarStructure = var_218.getValue(AvatarType.const_85) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc4_,_aliasCollection,param1,param2,AvatarType.const_85,param3);
      }
