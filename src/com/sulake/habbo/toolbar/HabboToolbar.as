package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_310.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_914,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_164,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_167,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_48,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_415,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_687,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1018,onHideWindowEvent);
         var_32 = true;
