package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         _main.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_48,onShowMenuEvent);
         _main.prepareForTutorial();
      }
      
      public function get id() : String
      {
         return TutorialUI.const_307;
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_562 = _main.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         ...
         _main.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU_ARROW,var_562));
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_48)
         {
            ...
            _main.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_399));
         }
      }
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_167,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      {
         setToolbarIconHighlight(false);
         _main.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_48,onShowMenuEvent);
      }
   }
}
