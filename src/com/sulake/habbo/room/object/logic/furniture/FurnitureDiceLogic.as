         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  {
                     _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_484,_loc3_,_loc4_);
                  }
                  else if(param1.spriteTag == "deactivate")
                  {
                     _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_392,_loc3_,_loc4_);
                  }
                  if(_loc5_ != null)
                  {
