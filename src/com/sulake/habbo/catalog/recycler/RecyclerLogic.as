package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_753:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1425)
         {
            case RecyclerStatusMessageEvent.const_1152:
               ...
               break;
            case RecyclerStatusMessageEvent.const_864:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1146:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1425 != RecyclerStatusMessageEvent.const_864;
      }
      
      private function get statusActive() : Boolean
      {
         return var_247 != const_754;
      }
      ...
      {
         return active && var_247 == const_345;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1007:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1229:
