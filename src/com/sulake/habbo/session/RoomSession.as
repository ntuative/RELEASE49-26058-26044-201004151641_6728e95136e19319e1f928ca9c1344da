package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1080:UserDataManager;
      ...
      {
         if(var_32 == RoomSessionEvent.const_306 && _connection != null)
         {
            var_32 = RoomSessionEvent.const_93;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1080 as IUserDataManager;
      }
