package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_515:Timer;
      
      private var var_153:IHabboConfigurationManager;
      
      private var var_1505:OpenedToWebPopup;
      
      private var var_863:IAvatarRenderManager;
      
      private var var_187:IHabboToolbar;
      
      private var var_407:FriendListTabs;
      ...
      private var var_1506:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_600:ISessionDataManager;
      
      private var var_355:FriendRequests;
      
      private var var_2035:int;
      
      var var_86:FriendCategories;
      
      private var var_2036:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_862:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2036 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_86 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1506 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_355.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_355.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_407.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_600 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_355 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_86.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_86.addCategory(new FriendCategory(FriendCategory.const_841,getText("friendlist.friends")));
         var_86.addCategory(new FriendCategory(FriendCategory.const_431,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_86.addFriend(new Friend(_loc4_));
         }
         var_407 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_515)
         {
            var_515 = new Timer(120000);
            var_515.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_515.start();
         }
         getBuddyRequests();
         registerListeners();
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_515.stop();
            var_515.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_515 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_137)
         {
            var_137.release(new IIDHabboMessenger());
            var_137 = null;
         }
         if(var_153)
         {
         ...
         if(var_863)
         {
            var_863.release(new IIDAvatarRenderManager());
            var_863 = null;
         }
         if(var_862)
         {
            var_862.release(new IIDHabboNotifications());
            var_862 = null;
         }
         if(var_187)
         {
         ...
         if(var_600)
         {
            var_600.release(new IIDSessionDataManager());
            var_600 = null;
         }
         super.dispose();
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = _windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var_86.onFriendListUpdate(param1);
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_407.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_331));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1506.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_167,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_355.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_86.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_600.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_600.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_355.limit)
         {
            var_355.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_407.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_863.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_355.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_407.findTab(FriendListTab.const_88);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_86.getFriendCount(param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1505 == null)
         {
            var_1505 = new OpenedToWebPopup(this);
         }
         var_1505.show(x,y);
      }
