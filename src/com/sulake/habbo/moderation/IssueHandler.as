package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_389:UserInfoCtrl;
      
      private var var_56:ModerationManager;
      
      private var var_965:UserInfoCtrl;
      
      private var var_106:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.releaseBundle(var_106.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = var_106.getHighestPriorityIssue();
         var_389 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_965 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_389.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_106.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_965.load(_loc4_,var_106.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_106.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_106.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_106.getHighestPriorityIssue().issueId;
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_888,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_56 != null && false && var_106 != null)
         {
            var_56.issueManager.removeHandler(var_106.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_106.getHighestPriorityIssue();
            var_389 = new UserInfoCtrl(_window,var_56,_loc3_.message);
            var_389.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_106.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_106.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1373;
      }
   }
}
