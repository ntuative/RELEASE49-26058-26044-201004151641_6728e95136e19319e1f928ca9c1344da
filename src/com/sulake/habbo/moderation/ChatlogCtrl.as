package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1564:IMessageComposer;
      ...
      private var var_1367:Dictionary;
      ...
      {
         var_926 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         ...
         _main.connection.send(var_1564);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_926.clone());
      ...
      {
         if(param1.type != WindowEvent.const_46 || param2 != var_52)
         {
            return;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = var_1367[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
