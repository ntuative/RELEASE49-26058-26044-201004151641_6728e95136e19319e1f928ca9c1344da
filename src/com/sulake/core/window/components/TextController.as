package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2354:Rectangle = new Rectangle();
       
      
      protected var var_210:Boolean;
      
      protected var var_67:TextMargins;
      
      protected var var_546:String = "none";
      
      protected var var_638:Number;
      
      protected var var_376:Number;
      ...
      {
         return new Rectangle(var_638 * maxScrollH,var_376 * maxScrollV,width,height);
      }
      ...
      {
         var_638 = param1;
         _field.scrollH = var_638 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_956,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_379,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_62,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_379,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_62,true));
         ...
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_633,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_633,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_left",var_67.left,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_top",var_67.top,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_right",var_67.right,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_67.bottom,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("auto_size",var_546,PropertyStruct.STRING,var_546 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_62,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_62,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_62,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_62,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_633,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_638 = var_638;
         _loc1_.var_376 = var_376;
         _loc1_.var_67 = var_67.clone(_loc1_.setTextMargins);
         _loc1_.var_546 = var_546;
         _loc1_.var_772 = var_772;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_546 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_546 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_546 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_546 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
