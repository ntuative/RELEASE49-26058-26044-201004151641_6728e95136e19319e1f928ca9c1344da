package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_841:int = 0;
      ...
      {
         return Math.ceil(this.var_225.length / const_339);
      }
      ...
      {
         if(this.var_847 >= this.getPageCount())
         {
            this.var_847 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_847 + 1) * const_339,this.var_225.length);
      }
