package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_508,RoomWidgetStickieSendUpdateMessage.const_713,RoomWidgetStickieSendUpdateMessage.const_437];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_508:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_931);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_598,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
                     _container.events.dispatchEvent(_loc11_);
                  }
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_437:
               ...
               {
                  _container.roomEngine.modifyRoomObjectData(_loc4_.objectId,RoomObjectCategoryEnum.const_31,_loc4_.colorHex + " " + _loc4_.text);
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_713:
               ...
               if(_container != null && false)
               {
                  _container.roomEngine.deleteRoomObject(_loc5_.objectId,RoomObjectCategoryEnum.const_31);
               }
               break;
         }
         return null;
