package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1535:Number = 1;
      
      private var var_1982:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1535,var_1531,var_1533,_alphaMultiplier);
         var_1024 = generatePaletteMapForGrayscale(var_1983,var_1981);
      }
      
      public function get reds() : Array
      {
         return var_1024.getValue("reds") as Array;
      }
      ...
      {
         return var_1024.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1024.getValue("greens") as Array;
      }
      ...
      {
         return var_1024.getValue("alphas") as Array;
      }
