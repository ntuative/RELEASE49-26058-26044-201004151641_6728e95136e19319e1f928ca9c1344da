package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManager extends Component implements IHabboSoundManager
   {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _roomEngine.events.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_823,onPlayEvent);
      }
      ...
      private function storeVolumeSetting() : void
      {
         if(_connection != null)
         {
            _connection.send(new SetSoundSettingsComposer(int(var_668 * 100)));
         }
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = var_1568.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_873:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1292:
               ...
               case HabboSoundTypesEnum.const_1217:
                  ...
                  break;
               case HabboSoundTypesEnum.const_925:
                  _loc3_ = "sound_catalogue_pixels";
                  break;
               case HabboSoundTypesEnum.const_797:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1328:
            ...
            var_1568.add(param1,_loc2_);
         }
         _loc2_.volume = var_668;
         _loc2_.play();
      }
   }
}
