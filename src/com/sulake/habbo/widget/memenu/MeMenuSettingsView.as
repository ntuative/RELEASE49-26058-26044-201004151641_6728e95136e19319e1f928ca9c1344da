package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_669:MeMenuSettingsViewSlider;
      
      private var var_1437:BitmapData;
      
      private var var_1438:BitmapData;
      
      private var var_668:Number = 1;
      
      private var var_1439:BitmapData;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_534);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_580);
         }
      ...
      {
         var_668 = param1.volume;
         if(var_669 != null)
         {
            var_669.setValue(var_668);
         }
         setSoundsOffIcon();
         method_4();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            var_1439 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1437 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = _widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1438 = (_loc5_.content as BitmapData).clone();
         }
         var_669 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         method_4();
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.const_32,onButtonOut);
         }
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_601));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               if(var_668 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1438);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1439);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1440);
      ...
      private function method_4(param1:BitmapData = null) : void
      {
         if(param1 != null)
         {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1437);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1438);
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               _widget.changeView(MeMenuWidget.const_129);
               break;
            default:
