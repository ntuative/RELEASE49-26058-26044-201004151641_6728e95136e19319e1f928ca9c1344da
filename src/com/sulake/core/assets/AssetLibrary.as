package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_995:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_574:uint = 0;
      
      public static const const_821:String = "AssetLibraryReady";
      
      public static const const_1289:String = "AssetLibraryUnloaded";
      
      public static const const_447:String = "AssetLibraryLoaded";
      
      public static const const_1148:String = "AssetLibraryLoadError";
       
      
      private var var_480:XML;
      ...
      private var var_481:Boolean = true;
      
      private var var_345:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_409 = new Dictionary(false);
         var_681 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_408)
         {
            _loc4_ = AssetTypeDeclaration(var_408[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_681)
         {
            delete var_681[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
         ...
         var_295 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1289));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_480 = _loc2_.manifest.copy();
         var_345 = _loc2_.resource;
         if(var_481)
         {
            AssetLibrary.fetchLibraryContents(this,var_480,var_345);
         }
         var_295 = true;
         dispatchEvent(new Event(AssetLibrary.const_447));
         dispatchEvent(new Event(AssetLibrary.const_821));
         if(var_481)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_409[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_36,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_47,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_822,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_814,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_835,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1000,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_409[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_408.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_408[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_995.splice(var_995.indexOf(this),1);
            --var_574;
            var_409 = null;
            var_681 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_346.length ? getAssetByName(var_346[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1148));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_408)
         {
            _loc3_ = AssetTypeDeclaration(var_408[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_681[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_480.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_345[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_409[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_346.splice(var_346.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_408[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_345 != null ? false : false;
      }
   }
}
