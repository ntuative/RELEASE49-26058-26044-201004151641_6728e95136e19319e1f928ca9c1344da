package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1542:UserTagManager;
      ...
      private var var_1543:GroupDetailsView;
      
      private var _name:String;
      
      private var var_526:int = 0;
      
      private var var_1063:FurnitureDataParser;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_18:IRoomSessionManager;
      
      private var var_1288:BadgeImageManager;
      ...
      private var var_1064:HabboGroupInfoManager;
      
      private var var_624:String;
      
      private var var_2102:Boolean;
      
      private var var_1065:ProductDataParser;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_732 = [];
         var_1542 = new UserTagManager(events);
         var_1064 = new HabboGroupInfoManager(this,events);
      ...
      {
         var_1065.removeEventListener(ProductDataParser.READY,onProductsReady);
         var_1065 = null;
         var_612 = new Map();
         var_477 = new Map();
         var_433 = new Map();
         ...
         var_1063 = new FurnitureDataParser(_loc2_,var_612,var_477,var_433,_localization);
         var_1063.addEventListener(FurnitureDataParser.READY,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1542.getTags(param1);
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_153.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_1065 = new ProductDataParser(_loc2_,var_874);
         var_1065.addEventListener(ProductDataParser.READY,onProductsReady);
      }
      ...
      {
         return var_1064.getBadgeId(param1);
      }
      ...
      {
         return var_1288.getBadgeImage(param1,BadgeImageManager.const_973);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _id = _loc3_.id;
         _name = _loc3_.name;
         var_2141 = _loc3_.respectTotal;
         var_881 = _loc3_.respectLeft;
         var_526 = _loc3_.petRespectLeft;
         var_293 = _loc3_.figure;
         var_624 = _loc3_.sex;
         var_1240 = _loc3_.realName;
      ...
      {
         return var_1064.getGroupDetails(param1);
      }
      ...
      public function getFloorItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getFloorItemData(parseInt(var_433.getValue(param1)));
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_2101 = _loc2_.isOpen;
         var_2102 = _loc2_.onShutDown;
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return var_1288.getBadgeImage(param1);
      }
      
      public function giveRespect(param1:int) : void
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_881 < 1 || _loc2_ == null)
         {
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1543 == null)
         {
            var_1543 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_1064.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1543.showGroupDetails(param1);
         }
      }
      
      private function onFurnitureReady(param1:Event = null) : void
      {
         var_1063.removeEventListener(FurnitureDataParser.READY,onFurnitureReady);
         var_1063 = null;
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_526 < 1 || _loc2_ == null)
         {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_293 = _loc2_.figure;
            var_624 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_293,var_624));
         }
      }
      ...
      public function hasUserRight(param1:String) : Boolean
      {
         ...
         return var_732.indexOf(param1) >= 0;
      }
      ...
      public function getWallItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getWallItemData(parseInt(var_433.getValue(param1)));
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1542.communication = _communication;
         var_1064.communication = _communication;
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_612.getValue(param1.toString());
      }
      ...
      public function get isAnyRoomController() : Boolean
      {
         ...
         return var_732.indexOf("fuse_any_room_controller") >= 0;
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1288 = new BadgeImageManager(_loc1_,events,var_153,_localization);
      }
