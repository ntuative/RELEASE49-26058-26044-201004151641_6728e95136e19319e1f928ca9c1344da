package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_448:PartSetsData;
      
      private var var_2237:PartOffsetData;
      
      private var var_923:AvatarActionManager;
      
      private var var_177:IAssetLibrary;
      
      private var var_1095:IAssetLibrary;
      
      private var var_2236:AvatarRenderManager;
      
      private var var_319:FigureData;
      ...
      private var var_1591:AvatarStructureDownloadSet;
      
      private var var_1361:Array;
      
      private var var_761:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_177 = param2;
         var_1095 = param3;
         var_319 = new FigureData();
         var_448 = new PartSetsData();
         _animationData = new AnimationData();
         var_1591 = new AvatarStructureDownloadSet();
         var_761 = new AnimationManager();
         var_760 = param4;
         var_2237 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_761.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_448.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_448.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1178[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_319.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_319.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_448.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_448.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_760 + " ready to go!");
         if(var_760 == AvatarType.const_85)
         {
            var_448.getPartDefinition("ri").appendToFigure = true;
            var_448.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_760)
         {
            case AvatarType.const_85:
               ...
               var_1591.add(new AvatarStructureDownload(var_177,_loc5_,var_319));
               break;
            case AvatarType.PET:
         }
         var_1591.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_761.getAnimation(param1);
      }
      ...
      {
         var_923 = new AvatarActionManager(var_177,var_760);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1361 = var_319.getMandatorySetTypeIds();
         return var_1361;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_319.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1095.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1095.getAssetByName("dance" + _loc1_).content as XML;
            var_761.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1095.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1095.getAssetByName("fx" + _loc1_).content as XML;
            var_761.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_319.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_319.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
