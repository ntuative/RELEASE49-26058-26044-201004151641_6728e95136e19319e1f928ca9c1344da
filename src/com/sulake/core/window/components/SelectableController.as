package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
            ...
            if(var_8)
            {
               if(!(var_8 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_195,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_454,this,null);
         update(this,_loc1_);
         ...
         _loc1_.type = WindowNotifyEvent.const_334;
         update(this,_loc1_);
         return true;
      }
      ...
      public function unselect() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_728;
         update(this,_loc1_);
         return true;
      }
   }
