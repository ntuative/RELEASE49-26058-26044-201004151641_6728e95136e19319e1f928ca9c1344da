package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_325:uint = 2;
      
      public static const const_457:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_249:uint = 3;
      
      public static const const_163:uint = 1;
      
      public static const const_181:uint = 0;
      
      public static const const_1390:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_464 = false;
         var_660 = false;
         var_44.updateItemList(var_661);
         var_44.updateItemList(var_1146);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         else if(param1 is TradingAcceptEvent)
         {
            ...
            if(TradingAcceptEvent(param1).userID == var_661)
            {
               var_464 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_660 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_44.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_661)
            {
               var_44.alertPopup(TradingView.const_999);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_32 + " NEW STATE: " + param1 + " OWN: " + var_464 + " OTHER: " + var_660);
         ...
         {
            case const_181:
               if(param1 == const_163 || param1 == const_216)
               {
                  var_32 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_44.setMinimized(param1 != InventoryCategory.const_75);
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_174)
            {
      ...
      public function close() : void
      {
         if(var_621)
         {
            if(var_32 != const_181 && var_32 != const_216)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_181;
            var_10.toggleInventorySubPage(InventorySubCategory.const_982);
            var_621 = false;
         }
         var_44.setMinimized(false);
      }
