package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2357:String = "magic.pixels";
      
      private var var_2358:String = "catalog.page.club";
      
      private var var_2381:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_253 = [];
         var_48 = _container.findChildByName("navigationList") as IItemListWindow;
         ...
         _loc3_.addEventListener(WindowMouseEvent.const_32,onNavigatorEvent);
         ...
         _loc4_.addEventListener(WindowMouseEvent.const_32,onNavigatorEvent);
         ...
         _loc5_.addEventListener(WindowMouseEvent.const_32,onNavigatorEvent);
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","HabboNavigatorCom_tag_m_png") == "true";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2358,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_253.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_253)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_253.indexOf(_loc6_);
            var_253.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_48);
            }
         }
      }
