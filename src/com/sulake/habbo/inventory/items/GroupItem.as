package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1633:int = 13421772;
      ...
      protected var var_2283:BitmapData;
      
      protected var var_947:Boolean;
      ...
      protected var var_451:int = 0;
      
      protected var var_1385:String;
      
      private const const_1632:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_374:BitmapData;
      
      private const const_1417:Number = 0.2;
      
      protected var var_1386:Boolean;
      
      private const const_1418:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_535)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(_mainCategory == FurniModel.const_44)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1585));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1385);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1417;
               _loc1_.blend = const_1417;
            }
            else
            {
               _window.blend = const_1418;
               _loc1_.blend = const_1418;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1386 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2283;
               _loc5_.visible = true;
            }
            else
            {
