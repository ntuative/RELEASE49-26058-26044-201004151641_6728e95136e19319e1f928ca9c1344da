package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_912:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_51.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_123.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_123.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_51.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_570)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_388)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_51.getParts(param1,(var_912 as AvatarImage).getFigure(),_loc6_,var_1155,_loc4_,_loc13_,_loc14_);
      ...
      private function createUnionImage(param1:Array) : ImageData
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc5_:* = null;
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_51.getCanvas(var_183,var_1155);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1214[param1])
            {
            ...
            _loc9_ = var_183 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_183 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            ...
            else
            {
               ...
               {
                  _loc31_ = var_51.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc29_ == AvatarAction.const_933 || _loc29_ == AvatarAction.const_506) && (_loc6_ == AvatarBodyPartType.const_301 || _loc6_ == AvatarBodyPartType.const_1253 || _loc6_ == AvatarBodyPartType.const_1327) && _loc7_.color != null)
               {
               ...
               _loc30_ = new ImageData(_loc8_,_loc14_.offset);
         ...
         var _loc24_:ImageData = createUnionImage(_loc22_);
         _loc24_.flipH = _loc17_;
         var _loc25_:Point = new Point(-_loc24_.regpoint.x,_loc21_.y - _loc24_.regpoint.y);
         if(_loc17_)
         {
            if(var_183 == AvatarScaleType.const_55)
            {
               _loc25_.x += 67;
            }
            else
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_51.getActiveBodyPartIds(param1);
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_123 != null)
         {
            _loc2_ = var_123.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_123.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_51.getBodyPartsUnordered(param1);
