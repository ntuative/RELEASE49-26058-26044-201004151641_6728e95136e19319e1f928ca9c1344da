package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1358.indexOf(param1) > -1;
      }
      ...
      {
         return var_759.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1360.length)
         {
            _loc2_ = var_759.indexOf(var_1360[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_317[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_856 + _loc3_);
                  _loc3_ += var_1359;
               }
            }
            _loc4_++;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_759.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_317[var_759.indexOf(param1)];
      }
