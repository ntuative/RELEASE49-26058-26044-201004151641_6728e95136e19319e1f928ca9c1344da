package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1085:Number = 30;
      ...
      private var var_708:Vector3d;
      
      private var var_1209:Number;
      ...
      {
         var_708 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1209 = param3;
         var_2013 = param4 * 0 * 2 / 360;
         var_1497 = param5 * 0 * 2 / 360;
         _height = param6;
         var_856 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1209 * Math.cos(var_856 + var_1497);
         var _loc4_:Number = var_1209 * Math.sin(var_856 + var_1497);
         var _loc5_:Number = _height;
         var_708.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_708.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_708.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_708.add(param1);
         }
