package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1158:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_564 != null)
         {
            var_564.visible = false;
            var_564.destroyGridItems();
         }
         if(var_1158 != null)
         {
            var_1158.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1279.text = "${" + _loc3_.name + "}";
            var_1278.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1279.text = "${" + _loc2_.localizationId + "}";
            var_1278.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_474:
                  _loc4_ = var_1157.clone();
                  if(var_564 != null)
                  {
                     var_564.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_564,var_1158,var_1244);
                  }
                  break;
               ...
               case Offer.const_411:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_210:
                        ...
                        _loc4_ = new BitmapData(var_79.width,var_79.height,false,_loc10_);
                        _loc11_ = null;
                        _loc12_ = page.viewer.catalog as HabboCatalog;
                        if(_loc12_.avatarRenderManager != null)
                        {
                           _loc14_ = _loc12_.sessionDataManager.figure;
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_55);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_49,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_321,AvatarAction.const_732);
                              _loc13_.appendAction(AvatarAction.const_614,_loc6_.productClassId);
      ...
      {
         var_1279 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1278 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_79 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1431 = new Point(var_79.x,var_79.y);
         var_564 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1158 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_564 == null)
         {
         ...
         var_1157 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_79);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_36,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_79 != null && true)
         {
            ...
            if(true)
            {
               var_79.bitmap = new BitmapData(var_79.width,var_79.height,true,16777215);
            }
            var_79.bitmap.fillRect(var_79.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_79.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_79.invalidate();
            var_79.x = var_1431.x;
            var_79.y = var_1431.y;
            if(param3 != null)
