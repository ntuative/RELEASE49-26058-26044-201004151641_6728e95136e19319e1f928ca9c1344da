package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_485:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_616;
         }
         if(param1 == 3)
         {
            return Tabs.const_588;
         }
         if(param1 == 4)
         {
      ...
      {
         var _loc1_:int = var_485 == null ? 0 : int(var_485.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_485 == null)
         {
            var_485 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_485.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
