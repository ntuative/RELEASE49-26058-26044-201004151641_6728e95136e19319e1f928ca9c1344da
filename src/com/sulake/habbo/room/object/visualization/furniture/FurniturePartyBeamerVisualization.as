package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_747:int = 15;
      
      private static const const_1040:int = 2;
      
      private static const const_346:int = 2;
      
      private static const const_748:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_969[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_968[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_969 = new Array();
         var_969.push(Math.random() * _loc2_ * 1.5);
         var_969.push(Math.random() * _loc2_ * 1.5);
         var_966 = new Array();
         var_966.push(1);
         var_966.push(-1);
         var_967 = new Array();
         var_967.push(const_1040);
         var_967.push(const_1039);
         var_968 = new Array();
         var_968.push(getRandomAmplitudeFactor());
         var_968.push(getRandomAmplitudeFactor());
      }
