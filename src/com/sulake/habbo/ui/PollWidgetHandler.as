package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_311;
      }
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_471,RoomWidgetPollMessage.const_662];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_117:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_117);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_68:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_68);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_109:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_109);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_662:
               _container.roomSession.sendPollStartMessage(_loc2_.id);
               break;
            case RoomWidgetPollMessage.const_471:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionPollEvent.const_117);
         _loc1_.push(RoomSessionPollEvent.const_68);
         _loc1_.push(RoomSessionPollEvent.const_109);
         return _loc1_;
      }
