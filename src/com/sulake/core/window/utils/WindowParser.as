package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1461:String = "_INCLUDE";
      
      public static const const_988:String = "_EXCLUDE";
      
      public static const const_1539:String = "_TEMP";
      
      private static const const_1054:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1055:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1113:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_946:Dictionary;
      
      protected var var_1384:Map;
      
      protected var var_15:IWindowContext;
      
      protected var var_1383:Dictionary;
      
      protected var var_1112:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1113 = new Dictionary();
         TypeCodeTable.fillTables(var_1112,var_1113);
         var_946 = new Dictionary();
         var_1383 = new Dictionary();
         ParamCodeTable.fillTables(var_946,var_1383);
         var_1384 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1055,"");
         return param1.replace(const_1054,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1112)
            {
               delete var_1112[_loc1_];
            }
            for(_loc1_ in var_1113)
            {
               delete var_1113[_loc1_];
            }
            for(_loc1_ in var_946)
            {
               delete var_946[_loc1_];
            }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         window = var_15.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,parseProperties(xml.child("variables")[0]),tags) as WindowController;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_988) == -1)
                  {
