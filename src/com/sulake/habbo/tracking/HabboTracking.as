package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_864:LagWarningLogger = null;
      
      private var var_865:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_864 = new LagWarningLogger();
         var_1262 = new Array(const_774);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1375,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1155,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_715,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_974,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_586:
               trackLoginStep(HabboLoginTrackingStep.const_1215,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_176:
               ...
               break;
            case HabboCommunicationEvent.const_157:
               setErrorContextFlag(2,0);
               trackLoginStep(HabboLoginTrackingStep.const_157);
               break;
            case HabboCommunicationEvent.const_217:
               setErrorContextFlag(3,0);
               trackLoginStep(HabboLoginTrackingStep.const_217);
               if(var_230 != null)
               {
                  var_230.init();
               }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_331:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_153)
         {
            Component(var_153).events.addEventListener(HabboConfigurationEvent.const_175,onConfigurationLoaded);
            if(var_230 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_265.events.addEventListener(AdEvent.const_355,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2037)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1170);
            var_2037 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_974,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_715,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_586,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_223,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_157,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_176,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_217,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_739,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_68,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_433,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_464:
               var_864.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_865)
            {
               var_865.release(new IIDHabboWindowManager());
               var_865 = null;
            }
            if(var_265)
            {
            ...
            if(var_170)
            {
               if(true)
               {
                  ...
                  Component(var_170).events.removeEventListener(HabboFriendListTrackingEvent.const_331,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_464,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_175);
         if(var_153)
         {
            if(var_864 != null)
            {
               var_864.configure(var_153);
            }
            Component(var_153).events.removeEventListener(HabboConfigurationEvent.const_175,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_897);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_897,onCoreRunning);
         }
      }
      ...
      {
         var_865 = IHabboWindowManager(param2);
         if(var_865)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1040 > -1 && _loc2_ < var_1040)
         {
            ++var_1507;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1507);
         }
         if(var_1040 > -1 && _loc2_ - var_1040 > 15000)
         {
            ++var_1508;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1508);
         }
         var_1040 = _loc2_;
         if(var_229 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_464,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_270,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_170).events.addEventListener(HabboFriendListTrackingEvent.const_331,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_739)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1202);
         }
         else if(param1.type == HabboHotelViewEvent.const_433)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1366);
         }
         else if(param1.type == HabboHotelViewEvent.const_68)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1220);
         }
      }
   }
}
