package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1595:int = "F".charCodeAt(0);
      
      public static const const_1555:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_624 = param1.gender;
         var_691 = param1.online;
         var_1242 = param1.followingAllowed && param1.online;
         var_293 = param1.figure;
         var_1241 = param1.motto;
         var_1243 = param1.lastAccess;
         var_1222 = param1.categoryId;
         var_1240 = param1.realName;
