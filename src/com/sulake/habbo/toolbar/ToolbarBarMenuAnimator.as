package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1130:Number = 90;
      
      private static const const_762:int = 50;
      
      private static const const_1061:Number = 25;
      
      private static const const_1060:int = 50;
      
      private static const const_188:Boolean = true;
       
      
      private var var_577:Timer;
      
      private var var_997:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_997 = param2;
         var_577 = new Timer(const_1061);
         var_577.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_483.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_483.splice(_loc3_,1);
            var_482.splice(_loc3_,1);
         }
         var_482.push(param1.name);
         var_483.push(param2);
         param1.addEventListener(WindowEvent.const_456,windowEventListener);
         param1.addEventListener(WindowEvent.const_214,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_483[var_482.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_997.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_296.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_296.splice(var_296.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_997.getIconLoc(param1.iconId);
      ...
      {
         return var_482[var_483.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_296[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_576[_loc3_] = new Array();
            }
            if(var_576[_loc3_].indexOf(param1) < 0)
            {
               var_576[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_762 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_762 || param1.desktop.height - param1.y < const_1060;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_482.length)
         {
            if(var_482[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_576[_loc3_].length)
                  {
                     repositionWindow(var_576[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
