package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_746:uint = 4284532064;
      
      private static const const_745:uint = 2577770;
      ...
      private var var_332:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_332 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_174)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_904)
            {
            ...
            var_332.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_409);
            var_332.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_162)
            {
               var_162.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_162.stop();
               var_162 = null;
            }
            if(var_332 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1412 == null)
         {
            var_1412 = createMinimizedWindow();
         }
         if(!var_1661)
         {
            return var_61;
      ...
      private function createNormalWindow() : IWindowContainer
      {
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_32,ownThumbEventProc);
            _loc6_++;
         }
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_32,othersThumbEventProc);
            _loc6_++;
         }
      ...
      public function startConfirmCountdown() : void
      {
         if(var_162 == null)
         {
            var_162 = new Timer(1000,3);
            var_162.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_162.reset();
         var_162.repeatCount = 3;
         var_162.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_61)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_746) : uint(const_745);
            }
