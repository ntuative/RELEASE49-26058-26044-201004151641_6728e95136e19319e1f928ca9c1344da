package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_610[var_1056] as Array;
      ...
      {
         var _loc2_:Offer = var_610[var_1056][var_2093];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_361 || _loc1_.pricingModel == Offer.const_411)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_80 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1057.indexOf(_loc5_) == -1)
                        {
                           var_1057.push(_loc5_);
                           var_610.push(new Array());
                        }
                        _loc6_ = var_1057.indexOf(_loc5_);
                        (var_610[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_610)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_610)
         {
            if(var_2093 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2093] as Offer;
               method_6(_loc3_);
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1056 = var_943.getGridItemIndex(param1.view);
