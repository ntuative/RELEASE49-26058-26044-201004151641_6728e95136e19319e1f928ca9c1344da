package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_139 = _window.width;
         var_207 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_800,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1106 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1106)
         {
         ...
         var_1378 = _loc7_.toolbar.@margin_bottom;
         var_1606 = _loc7_.toolbar.@min_group_margin;
         var_1607 = _loc7_.toolbar.@margin_to_extrabar;
         var_261 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_284,param1,param2,_window,var_261);
         createGroupsFromXmlList(_loc9_,var_633,param1,param2,var_207,var_261);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_284.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_633.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_139,var_540,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_139;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_207.x = var_139 + var_1607;
               var_207.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_139;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_139;
               _window.y = 0;
               var_207.x = 0;
               var_207.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_139;
               _window.x = 0;
               _window.y = 0;
               var_207.x = 0;
               var_207.y = var_139 + var_1607;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_139;
               _window.x = 0;
               _window.y = _loc1_.height - var_139;
               var_207.x = 0;
               var_207.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1606,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1378) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1606,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1378) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_633.length)
         {
            _loc3_ = var_633[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_139);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_139)
         {
            return "RIGHT";
         }
         if(param2 <= var_139)
         ...
         if(param2 >= _loc3_.height - var_139)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_139,var_540);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_284.length)
         {
            _loc2_ = var_284[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < var_633.length)
         {
            _loc2_ = var_633[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_540);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_139,var_540);
         }
      }
