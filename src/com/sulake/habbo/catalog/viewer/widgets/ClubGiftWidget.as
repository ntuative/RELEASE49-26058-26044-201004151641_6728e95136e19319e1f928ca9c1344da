package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_609.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_206)
         {
            var_206 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_206)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_206.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_206.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_206.visible = true;
         var_206.activate();
      }
      ...
      {
         if(!param1 || !param2 || !var_609 || !var_47)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_609.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
      ...
      private function mouseOverHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_32)
         {
            hidePreview();
         }
      }
